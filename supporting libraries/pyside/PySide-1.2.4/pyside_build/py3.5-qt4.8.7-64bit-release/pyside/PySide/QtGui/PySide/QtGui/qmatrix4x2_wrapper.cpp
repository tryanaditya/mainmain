...
Sbk_QMatrix4x2_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (!PyArg_UnpackTuple(args, "QMatrix4x2", 1, 1, &(pyArgs[0])))
        return -1;


    // Overloaded function decisor
    // 0: QMatrix4x2(PySequence*)
    // 1: QMatrix4x2(QMatrix4x2)
    if (numArgs == 1
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], (pyArgs[0])))) {
        overloadId = 1; // QMatrix4x2(QMatrix4x2)
    } else if (numArgs == 1
        && PySequence_Check(pyArgs[0])) {
        overloadId = 0; // QMatrix4x2(PySequence*)
    }
    ...
    switch (overloadId) {
        case 0: // QMatrix4x2(PySequence * arg__1)
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                if (PySequence_Size(pyArgs[1-1]) == 8) {
                    Shiboken::AutoDecRef fast(PySequence_Fast(pyArgs[1-1], "Failed to parse sequence on QMatrix4x2 constructor."));
                    qreal values[8];
                    for(int i=0; i < 8; i++) {
        ...
        case 1: // QMatrix4x2(const QMatrix4x2 & QMatrix4x2)
        {
            if (!Shiboken::Object::isValid(pyArgs[0]))
                return -1;
            ::QMatrix4x2 cppArg0_local = ::QMatrix4x2();
            ::QMatrix4x2* cppArg0 = &cppArg0_local;
            if (Shiboken::Conversions::isImplicitConversion((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], pythonToCpp[0]))
    ...
    Sbk_QMatrix4x2_Init_TypeError:
        const char* overloads[] = {"PySequence", "PySide.QtGui.QMatrix4x2", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QMatrix4x2", overloads);
        return -1;
}

static PyObject* Sbk_QMatrix4x2Func___reduce__(PyObject* self)
{
    ::QMatrix4x2* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QMatrix4x2*)Shiboken::Conversions::cppPointer(SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], (SbkObject*)self));
    PyObject* pyResult = 0;
...
static PyObject* Sbk_QMatrix4x2Func_fill(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QMatrix4x2Func_fill_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QMatrix4x2.fill", overloads);
        return 0;
}
...
static PyObject* Sbk_QMatrix4x2Func_transposed(PyObject* self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            QMatrix2x4 transp = cppSelf->transposed();
            return Shiboken::Conversions::copyToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX2X4_IDX], &transp);
...
static PyObject* Sbk_QMatrix4x2___copy__(PyObject* self)
{
    if (!Shiboken::Object::isValid(self))
        return 0;
    ::QMatrix4x2& cppSelf = *(((::QMatrix4x2*)Shiboken::Conversions::cppPointer(SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], (SbkObject*)self)));
    PyObject* pyResult = Shiboken::Conversions::copyToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], &cppSelf);
    if (PyErr_Occurred() || !pyResult) {
        Py_XDECREF(pyResult);
        return 0;
    }
...
static PyMethodDef Sbk_QMatrix4x2_methods[] = {
    {"__reduce__", (PyCFunction)Sbk_QMatrix4x2Func___reduce__, METH_NOARGS},
    {"data", (PyCFunction)Sbk_QMatrix4x2Func_data, METH_NOARGS},
    {"fill", (PyCFunction)Sbk_QMatrix4x2Func_fill, METH_O},
    {"transposed", (PyCFunction)Sbk_QMatrix4x2Func_transposed, METH_NOARGS},

    {"__copy__", (PyCFunction)Sbk_QMatrix4x2___copy__, METH_NOARGS},
    {0} // Sentinel
};

static PyObject* Sbk_QMatrix4x2Func___imul__(PyObject* self, PyObject* pyArg)
{
    bool isReverse = SbkObject_TypeCheck(SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], pyArg)
                    && !SbkObject_TypeCheck(SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], self);
    if (isReverse)
        std::swap(self, pyArg);
    ::QMatrix4x2* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            *cppSelf *= cppArg0;
            return Shiboken::Conversions::copyToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], &*cppSelf);
    ...
    Sbk_QMatrix4x2Func___imul___TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QMatrix4x2.__imul__", overloads);
        return 0;
}
...
static PyObject* Sbk_QMatrix4x2Func___iadd__(PyObject* self, PyObject* pyArg)
{
    ...
    // Overloaded function decisor
    // 0: operator+=(QMatrix4x2)
    if (!isReverse
        && (pythonToCpp = Shiboken::Conversions::isPythonToCppValueConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], (pyArg)))) {
        overloadId = 0; // operator+=(QMatrix4x2)
    }
    ...
    Sbk_QMatrix4x2Func___iadd___TypeError:
        const char* overloads[] = {"PySide.QtGui.QMatrix4x2", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QMatrix4x2.__iadd__", overloads);
        return 0;
}
...
static PyObject* Sbk_QMatrix4x2Func___isub__(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QMatrix4x2Func___isub___TypeError:
        const char* overloads[] = {"PySide.QtGui.QMatrix4x2", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QMatrix4x2.__isub__", overloads);
        return 0;
}
...
static PyObject* Sbk_QMatrix4x2Func___idiv__(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QMatrix4x2Func___idiv___TypeError:
        const char* overloads[] = {"float", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QMatrix4x2.__idiv__", overloads);
        return 0;
}
...
static PyObject* Sbk_QMatrix4x2_richcompare(PyObject* self, PyObject* pyArg, int op)
{
    ...
    switch (op) {
        case Py_NE:
            if ((pythonToCpp = Shiboken::Conversions::isPythonToCppValueConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], (pyArg)))) {
                // operator!=(QMatrix4x2 arg__1)
                if (!Shiboken::Object::isValid(pyArg))
                    return 0;
                ::QMatrix4x2 cppArg0 = ::QMatrix4x2();
                pythonToCpp(pyArg, &cppArg0);
...
// Class Definition -----------------------------------------------
extern "C" {
static PyNumberMethods Sbk_QMatrix4x2_TypeAsNumber;

static SbkObjectType Sbk_QMatrix4x2_Type = { { {
    PyVarObject_HEAD_INIT(&SbkObjectType_Type, 0)
    /*tp_name*/             "PySide.QtGui.QMatrix4x2",
    ...
    /*tp_setattr*/          0,
    /*tp_compare*/          0,
    /*tp_repr*/             Sbk_QMatrix4x2Func___repr__,
    /*tp_as_number*/        0,
    /*tp_as_sequence*/      0,
    /*tp_as_mapping*/       0,
    /*tp_hash*/             0,
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QMatrix4x2_traverse,
    /*tp_clear*/            Sbk_QMatrix4x2_clear,
    /*tp_richcompare*/      Sbk_QMatrix4x2_richcompare,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QMatrix4x2_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
...
static void QMatrix4x2_PythonToCpp_QMatrix4x2_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QMatrix4x2_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QMatrix4x2_PythonToCpp_QMatrix4x2_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QMatrix4x2_Type))
...
static PyObject* QMatrix4x2_PTR_CppToPython_QMatrix4x2(const void* cppIn) {
    ...
    const char* typeName = typeid(*((::QMatrix4x2*)cppIn)).name();
    return Shiboken::Object::newObject(&Sbk_QMatrix4x2_Type, const_cast<void*>(cppIn), false, false, typeName);
}

// C++ to Python copy conversion.
static PyObject* QMatrix4x2_COPY_CppToPython_QMatrix4x2(const void* cppIn) {
    return Shiboken::Object::newObject(&Sbk_QMatrix4x2_Type, new ::QMatrix4x2(*((::QMatrix4x2*)cppIn)), true, true);
}

// Python to C++ copy conversion.
static void QMatrix4x2_PythonToCpp_QMatrix4x2_COPY(PyObject* pyIn, void* cppOut) {
    *((::QMatrix4x2*)cppOut) = *((::QMatrix4x2*)Shiboken::Conversions::cppPointer(SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX], (SbkObject*)pyIn));
}
...
void init_QMatrix4x2(PyObject* module)
{
    ...
    memset(&Sbk_QMatrix4x2_TypeAsNumber, 0, sizeof(PyNumberMethods));
#ifndef IS_PY3K
    Sbk_QMatrix4x2_TypeAsNumber.nb_divide = Sbk_QMatrix4x2Func___idiv__;
#endif
    Sbk_QMatrix4x2_TypeAsNumber.nb_inplace_subtract = Sbk_QMatrix4x2Func___isub__;
    Sbk_QMatrix4x2_TypeAsNumber.nb_multiply = Sbk_QMatrix4x2Func___imul__;
    Sbk_QMatrix4x2_TypeAsNumber.nb_inplace_add = Sbk_QMatrix4x2Func___iadd__;
    Sbk_QMatrix4x2_Type.super.ht_type.tp_as_number = &Sbk_QMatrix4x2_TypeAsNumber;

    SbkPySide_QtGuiTypes[SBK_QMATRIX4X2_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QMatrix4x2_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QMatrix4x2", "QMatrix4x2",
        &Sbk_QMatrix4x2_Type, &Shiboken::callCppDestructor< ::QMatrix4x2 >)) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QMatrix4x2_Type,
