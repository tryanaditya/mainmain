...
#ifndef SBK_QGRAPHICSVIEWWRAPPER_H
#define SBK_QGRAPHICSVIEWWRAPPER_H
...
class QGraphicsViewWrapper : public QGraphicsView
{
public:
...
#endif // SBK_QGRAPHICSVIEWWRAPPER_H
