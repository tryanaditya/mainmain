...
#ifndef SBK_QCOLUMNVIEWWRAPPER_H
#define SBK_QCOLUMNVIEWWRAPPER_H
...
class QColumnViewWrapper : public QColumnView
{
public:
    QColumnViewWrapper(QWidget * parent = 0);
    ...
    virtual ~QColumnViewWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline void edit(const QModelIndex & index) { QColumnView::edit(index); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QCOLUMNVIEWWRAPPER_H
