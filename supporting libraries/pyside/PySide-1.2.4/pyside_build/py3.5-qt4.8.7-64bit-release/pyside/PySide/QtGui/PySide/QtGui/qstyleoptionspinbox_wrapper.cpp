...
Sbk_QStyleOptionSpinBox_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // 0: QStyleOptionSpinBox()
    // 1: QStyleOptionSpinBox(QStyleOptionSpinBox)
    // 2: QStyleOptionSpinBox(int)
    if (numArgs == 0) {
        ...
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_IDX], (pyArgs[0])))) {
    ...
    Sbk_QStyleOptionSpinBox_Init_TypeError:
        const char* overloads[] = {"", "PySide.QtGui.QStyleOptionSpinBox", "int", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QStyleOptionSpinBox", overloads);
        return -1;
}
...
{
    ::QStyleOptionSpinBox* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QStyleOptionSpinBox*)Shiboken::Conversions::cppPointer(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_IDX], (SbkObject*)self));
    PyObject* pyOut = Shiboken::Conversions::copyToPython(SBK_CONVERTER(SbkPySide_QtGuiTypes[SBK_QFLAGS_QABSTRACTSPINBOX_STEPENABLEDFLAG__IDX]), &cppSelf->stepEnabled);
    return pyOut;
}
static int Sbk_QStyleOptionSpinBox_set_stepEnabled(PyObject* self, PyObject* pyIn, void*)
{
    ...
    if (!(pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkPySide_QtGuiTypes[SBK_QFLAGS_QABSTRACTSPINBOX_STEPENABLEDFLAG__IDX]), (pyIn)))) {
...
static PyObject* Sbk_QStyleOptionSpinBox_get_buttonSymbols(PyObject* self, void*)
{
    ...
    PyObject* pyOut = Shiboken::Conversions::copyToPython(SBK_CONVERTER(SbkPySide_QtGuiTypes[SBK_QABSTRACTSPINBOX_BUTTONSYMBOLS_IDX]), &cppOut_local);
    return pyOut;
}
static int Sbk_QStyleOptionSpinBox_set_buttonSymbols(PyObject* self, PyObject* pyIn, void*)
{
    ...
    PythonToCppFunc pythonToCpp;
    if (!(pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkPySide_QtGuiTypes[SBK_QABSTRACTSPINBOX_BUTTONSYMBOLS_IDX]), (pyIn)))) {
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QStyleOptionSpinBox_Type = { { {
    PyVarObject_HEAD_INIT(&SbkObjectType_Type, 0)
    /*tp_name*/             "PySide.QtGui.QStyleOptionSpinBox",
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QStyleOptionSpinBox_traverse,
    /*tp_clear*/            Sbk_QStyleOptionSpinBox_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QStyleOptionSpinBox_methods,
    /*tp_members*/          0,
    /*tp_getset*/           Sbk_QStyleOptionSpinBox_getsetlist,
    /*tp_base*/             0,
    /*tp_dict*/             0,
    /*tp_descr_get*/        0,
    /*tp_descr_set*/        0,
    /*tp_dictoffset*/       0,
    /*tp_init*/             Sbk_QStyleOptionSpinBox_Init,
    /*tp_alloc*/            0,
...
static void QStyleOptionSpinBox_StyleOptionType_PythonToCpp_QStyleOptionSpinBox_StyleOptionType(PyObject* pyIn, void* cppOut) {
    *((::QStyleOptionSpinBox::StyleOptionType*)cppOut) = (::QStyleOptionSpinBox::StyleOptionType) Shiboken::Enum::getValue(pyIn);
...
static PythonToCppFunc is_QStyleOptionSpinBox_StyleOptionType_PythonToCpp_QStyleOptionSpinBox_StyleOptionType_Convertible(PyObject* pyIn) {
    if (PyObject_TypeCheck(pyIn, SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX]))
...
static PyObject* QStyleOptionSpinBox_StyleOptionType_CppToPython_QStyleOptionSpinBox_StyleOptionType(const void* cppIn) {
    int castCppIn = *((::QStyleOptionSpinBox::StyleOptionType*)cppIn);
    return Shiboken::Enum::newItem(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX], castCppIn);
...
static void QStyleOptionSpinBox_StyleOptionVersion_PythonToCpp_QStyleOptionSpinBox_StyleOptionVersion(PyObject* pyIn, void* cppOut) {
    *((::QStyleOptionSpinBox::StyleOptionVersion*)cppOut) = (::QStyleOptionSpinBox::StyleOptionVersion) Shiboken::Enum::getValue(pyIn);
...
static PythonToCppFunc is_QStyleOptionSpinBox_StyleOptionVersion_PythonToCpp_QStyleOptionSpinBox_StyleOptionVersion_Convertible(PyObject* pyIn) {
    if (PyObject_TypeCheck(pyIn, SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX]))
...
static PyObject* QStyleOptionSpinBox_StyleOptionVersion_CppToPython_QStyleOptionSpinBox_StyleOptionVersion(const void* cppIn) {
    int castCppIn = *((::QStyleOptionSpinBox::StyleOptionVersion*)cppIn);
    return Shiboken::Enum::newItem(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX], castCppIn);

}

// Python to C++ pointer conversion - returns the C++ object of the Python wrapper (keeps object identity).
static void QStyleOptionSpinBox_PythonToCpp_QStyleOptionSpinBox_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QStyleOptionSpinBox_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QStyleOptionSpinBox_PythonToCpp_QStyleOptionSpinBox_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QStyleOptionSpinBox_Type))
...
static PyObject* QStyleOptionSpinBox_PTR_CppToPython_QStyleOptionSpinBox(const void* cppIn) {
    ...
    const char* typeName = typeid(*((::QStyleOptionSpinBox*)cppIn)).name();
    return Shiboken::Object::newObject(&Sbk_QStyleOptionSpinBox_Type, const_cast<void*>(cppIn), false, false, typeName);
}

void init_QStyleOptionSpinBox(PyObject* module)
{
    SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QStyleOptionSpinBox_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QStyleOptionSpinBox", "QStyleOptionSpinBox*",
        &Sbk_QStyleOptionSpinBox_Type, &Shiboken::callCppDestructor< ::QStyleOptionSpinBox >, (SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONCOMPLEX_IDX])) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QStyleOptionSpinBox_Type,
    ...
    SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX] = Shiboken::Enum::createScopedEnum(&Sbk_QStyleOptionSpinBox_Type,
        "StyleOptionType",
        "PySide.QtGui.QStyleOptionSpinBox.StyleOptionType",
        "QStyleOptionSpinBox::StyleOptionType");
    if (!SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX])
        return ;

    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX],
        &Sbk_QStyleOptionSpinBox_Type, "Type", (long) QStyleOptionSpinBox::Type))
        return ;
    // Register converter for enum 'QStyleOptionSpinBox::StyleOptionType'.
    {
        SbkConverter* converter = Shiboken::Conversions::createConverter(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX],
        ...
        Shiboken::Enum::setTypeConverter(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX], converter);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONTYPE_IDX], converter);
    ...
    SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX] = Shiboken::Enum::createScopedEnum(&Sbk_QStyleOptionSpinBox_Type,
        "StyleOptionVersion",
        "PySide.QtGui.QStyleOptionSpinBox.StyleOptionVersion",
        "QStyleOptionSpinBox::StyleOptionVersion");
    if (!SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX])
        return ;

    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX],
        &Sbk_QStyleOptionSpinBox_Type, "Version", (long) QStyleOptionSpinBox::Version))
        return ;
    // Register converter for enum 'QStyleOptionSpinBox::StyleOptionVersion'.
    {
        SbkConverter* converter = Shiboken::Conversions::createConverter(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX],
        ...
        Shiboken::Enum::setTypeConverter(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX], converter);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONSPINBOX_STYLEOPTIONVERSION_IDX], converter);
