...
QItemDelegateWrapper::QItemDelegateWrapper(QObject * parent) : QItemDelegate(parent) {
    // ... middle
}
...
QWidget * QItemDelegateWrapper::createEditor(QWidget * parent, const QStyleOptionViewItem & option, const QModelIndex & index) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QItemDelegate.createEditor", Shiboken::SbkType< QWidget >()->tp_name, pyResult->ob_type->tp_name);
        return ((::QWidget*)0);
    }
    ::QWidget* cppResult;
...
bool QItemDelegateWrapper::editorEvent(QEvent * event, QAbstractItemModel * model, const QStyleOptionViewItem & option, const QModelIndex & index)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QItemDelegate.editorEvent", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool QItemDelegateWrapper::event(QEvent * arg__1)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QItemDelegate.event", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool QItemDelegateWrapper::eventFilter(QObject * object, QEvent * event)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QItemDelegate.eventFilter", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QSize QItemDelegateWrapper::sizeHint(const QStyleOptionViewItem & option, const QModelIndex & index) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QItemDelegate.sizeHint", Shiboken::SbkType< QSize >()->tp_name, pyResult->ob_type->tp_name);
        return ::QSize();
    }
...
void* QItemDelegateWrapper::qt_metacast(const char* _clname)
{
        if (!_clname) return 0;
        SbkObject* pySelf = Shiboken::BindingManager::instance().retrieveWrapper(this);
        if (pySelf && PySide::inherits(Py_TYPE(pySelf), _clname))
                return static_cast<void*>(const_cast< QItemDelegateWrapper* >(this));
...
extern "C" {
static int
Sbk_QItemDelegate_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    const char* argNames[] = {"parent"};
    const QMetaObject* metaObject;
    SbkObject* sbkSelf = reinterpret_cast<SbkObject*>(self);
    if (Shiboken::Object::isUserType(self) && !Shiboken::ObjectType::canCallConstructor(self->ob_type, Shiboken::SbkType< ::QItemDelegate >()))
        return -1;
    ...
    if (!PyArg_ParseTuple(args, "|O:QItemDelegate", &(pyArgs[0])))
        return -1;


    // Overloaded function decisor
    // 0: QItemDelegate(QObject*)
    if (numArgs == 0) {
        overloadId = 0; // QItemDelegate(QObject*)
    } else if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QOBJECT_IDX], (pyArgs[0])))) {
        overloadId = 0; // QItemDelegate(QObject*)
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegate_Init_TypeError;
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "PySide.QtGui.QItemDelegate(): got multiple values for keyword argument 'parent'.");
                return -1;
            } else if (value) {
                pyArgs[0] = value;
                if (!(pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QOBJECT_IDX], (pyArgs[0]))))
                    goto Sbk_QItemDelegate_Init_TypeError;
            }
        }
        ...
        if (!PyErr_Occurred()) {
            ...
            if (addr) {
                cptr = new (addr) ::QItemDelegateWrapper(cppArg0);
                PySide::setNextQObjectMemoryAddr(0);
            } else {
                cptr = new ::QItemDelegateWrapper(cppArg0);
            }
    ...
    if (PyErr_Occurred() || !Shiboken::Object::setCppPointer(sbkSelf, Shiboken::SbkType< ::QItemDelegate >(), cptr)) {
        delete cptr;
        return -1;
    }
    if (!cptr) goto Sbk_QItemDelegate_Init_TypeError;
    ...
    Sbk_QItemDelegate_Init_TypeError:
        const char* overloads[] = {"PySide.QtCore.QObject = None", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate", overloads);
        return -1;
}

static PyObject* Sbk_QItemDelegateFunc_check(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QItemDelegate*)Shiboken::Conversions::cppPointer(SbkPySide_QtGuiTypes[SBK_QITEMDELEGATE_IDX], (SbkObject*)self));
    PyObject* pyResult = 0;
    int overloadId = -1;
    ...
    // Overloaded function decisor
    // 0: check(QStyleOptionViewItem,QRect,QVariant)const
    if (numArgs == 3
        ...
        overloadId = 0; // check(QStyleOptionViewItem,QRect,QVariant)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_check_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QRect cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->check(*cppArg0, *cppArg1, cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_check_TypeError:
        const char* overloads[] = {"PySide.QtGui.QStyleOptionViewItem, PySide.QtCore.QRect, QVariant", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate.check", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_createEditor(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_createEditor_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QWidget * cppResult = Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::createEditor(cppArg0, *cppArg1, *cppArg2) : const_cast<const ::QItemDelegate*>(cppSelf)->createEditor(cppArg0, *cppArg1, *cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_createEditor_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_decoration(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: decoration(QStyleOptionViewItem,QVariant)const
    if (numArgs == 2
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide_QtCoreTypeConverters[SBK_QVARIANT_IDX], (pyArgs[1])))) {
        overloadId = 0; // decoration(QStyleOptionViewItem,QVariant)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_decoration_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QPixmap cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->decoration(*cppArg0, cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_decoration_TypeError:
        const char* overloads[] = {"PySide.QtGui.QStyleOptionViewItem, QVariant", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate.decoration", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_drawBackground(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: drawBackground(QPainter*,QStyleOptionViewItem,QModelIndex)const
    if (numArgs == 3
        ...
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QMODELINDEX_IDX], (pyArgs[2])))) {
        overloadId = 0; // drawBackground(QPainter*,QStyleOptionViewItem,QModelIndex)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_drawBackground_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            const_cast<const ::QItemDelegate*>(cppSelf)->drawBackground(cppArg0, *cppArg1, *cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_drawBackground_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_drawCheck(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: drawCheck(QPainter*,QStyleOptionViewItem,QRect,Qt::CheckState)const
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPAINTER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[1])))
        ...
        && (pythonToCpp[3] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkPySide_QtCoreTypes[SBK_QT_CHECKSTATE_IDX]), (pyArgs[3])))) {
        overloadId = 0; // drawCheck(QPainter*,QStyleOptionViewItem,QRect,Qt::CheckState)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_drawCheck_TypeError;
    ...
    // Call function/method
    {
        ...
        ::Qt::CheckState cppArg3 = ((::Qt::CheckState)0);
        pythonToCpp[3](pyArgs[3], &cppArg3);

        if (!PyErr_Occurred()) {
            // drawCheck(QPainter*,QStyleOptionViewItem,QRect,Qt::CheckState)const
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::drawCheck(cppArg0, *cppArg1, *cppArg2, cppArg3) : const_cast<const ::QItemDelegate*>(cppSelf)->drawCheck(cppArg0, *cppArg1, *cppArg2, cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_drawCheck_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_drawDecoration(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: drawDecoration(QPainter*,QStyleOptionViewItem,QRect,QPixmap)const
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPAINTER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QRECT_IDX], (pyArgs[2])))
        ...
        overloadId = 0; // drawDecoration(QPainter*,QStyleOptionViewItem,QRect,QPixmap)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_drawDecoration_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::drawDecoration(cppArg0, *cppArg1, *cppArg2, *cppArg3) : const_cast<const ::QItemDelegate*>(cppSelf)->drawDecoration(cppArg0, *cppArg1, *cppArg2, *cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_drawDecoration_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_drawDisplay(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: drawDisplay(QPainter*,QStyleOptionViewItem,QRect,QString)const
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPAINTER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QRECT_IDX], (pyArgs[2])))
        && (pythonToCpp[3] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[3])))) {
        overloadId = 0; // drawDisplay(QPainter*,QStyleOptionViewItem,QRect,QString)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_drawDisplay_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::drawDisplay(cppArg0, *cppArg1, *cppArg2, cppArg3) : const_cast<const ::QItemDelegate*>(cppSelf)->drawDisplay(cppArg0, *cppArg1, *cppArg2, cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_drawDisplay_TypeError:
        const char* overloads[] = {"PySide.QtGui.QPainter, PySide.QtGui.QStyleOptionViewItem, PySide.QtCore.QRect, unicode", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate.drawDisplay", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_drawFocus(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: drawFocus(QPainter*,QStyleOptionViewItem,QRect)const
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPAINTER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QRECT_IDX], (pyArgs[2])))) {
        overloadId = 0; // drawFocus(QPainter*,QStyleOptionViewItem,QRect)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_drawFocus_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::drawFocus(cppArg0, *cppArg1, *cppArg2) : const_cast<const ::QItemDelegate*>(cppSelf)->drawFocus(cppArg0, *cppArg1, *cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_drawFocus_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_editorEvent(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_editorEvent_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            bool cppResult = Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? cppSelf->::QItemDelegate::editorEvent(cppArg0, cppArg1, *cppArg2, *cppArg3) : cppSelf->editorEvent(cppArg0, cppArg1, *cppArg2, *cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_editorEvent_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_eventFilter(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_eventFilter_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            bool cppResult = Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? cppSelf->::QItemDelegate::eventFilter(cppArg0, cppArg1) : cppSelf->eventFilter(cppArg0, cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
        }
    }
    ...
    Sbk_QItemDelegateFunc_eventFilter_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_hasClipping(PyObject* self)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // hasClipping()const
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            bool cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->hasClipping();
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
        }
    }
...
static PyObject* Sbk_QItemDelegateFunc_itemEditorFactory(PyObject* self)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QItemEditorFactory * cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->itemEditorFactory();
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
...
static PyObject* Sbk_QItemDelegateFunc_paint(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_paint_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::paint(cppArg0, *cppArg1, *cppArg2) : const_cast<const ::QItemDelegate*>(cppSelf)->paint(cppArg0, *cppArg1, *cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_paint_TypeError:
        const char* overloads[] = {"PySide.QtGui.QPainter, PySide.QtGui.QStyleOptionViewItem, PySide.QtCore.QModelIndex", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate.paint", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_rect(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: rect(QStyleOptionViewItem,QModelIndex,int)const
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[0])))
        ...
        overloadId = 0; // rect(QStyleOptionViewItem,QModelIndex,int)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_rect_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QRect cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->rect(*cppArg0, *cppArg1, cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QRECT_IDX], &cppResult);
        }
    }
    ...
    Sbk_QItemDelegateFunc_rect_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_setClipping(PyObject* self, PyObject* pyArg)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_setClipping_TypeError;
    ...
    Sbk_QItemDelegateFunc_setClipping_TypeError:
        const char* overloads[] = {"bool", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QItemDelegate.setClipping", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_setEditorData(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_setEditorData_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::setEditorData(cppArg0, *cppArg1) : const_cast<const ::QItemDelegate*>(cppSelf)->setEditorData(cppArg0, *cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_setEditorData_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_setItemEditorFactory(PyObject* self, PyObject* pyArg)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: setItemEditorFactory(QItemEditorFactory*)
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QITEMEDITORFACTORY_IDX], (pyArg)))) {
        overloadId = 0; // setItemEditorFactory(QItemEditorFactory*)
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_setItemEditorFactory_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            cppSelf->setItemEditorFactory(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_setItemEditorFactory_TypeError:
        const char* overloads[] = {"PySide.QtGui.QItemEditorFactory", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtGui.QItemDelegate.setItemEditorFactory", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_setModelData(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_setModelData_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::setModelData(cppArg0, cppArg1, *cppArg2) : const_cast<const ::QItemDelegate*>(cppSelf)->setModelData(cppArg0, cppArg1, *cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_setModelData_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_setOptions(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: setOptions(QModelIndex,QStyleOptionViewItem)const
    if (numArgs == 2
        ...
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QSTYLEOPTIONVIEWITEM_IDX], (pyArgs[1])))) {
        overloadId = 0; // setOptions(QModelIndex,QStyleOptionViewItem)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_setOptions_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QStyleOptionViewItem cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->setOptions(*cppArg0, *cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_setOptions_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_sizeHint(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_sizeHint_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QSize cppResult = Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::sizeHint(*cppArg0, *cppArg1) : const_cast<const ::QItemDelegate*>(cppSelf)->sizeHint(*cppArg0, *cppArg1);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QItemDelegateFunc_sizeHint_TypeError:
...
static PyObject* Sbk_QItemDelegateFunc_textRectangle(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Overloaded function decisor
    // 0: textRectangle(QPainter*,QRect,QFont,QString)const
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPAINTER_IDX], (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppReferenceConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QRECT_IDX], (pyArgs[1])))
        ...
        && (pythonToCpp[3] = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], (pyArgs[3])))) {
        overloadId = 0; // textRectangle(QPainter*,QRect,QFont,QString)const
    }

    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_textRectangle_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QRect cppResult = const_cast<const ::QItemDelegate*>(cppSelf)->textRectangle(cppArg0, *cppArg1, *cppArg2, cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QRECT_IDX], &cppResult);
        }
    }
    ...
    Sbk_QItemDelegateFunc_textRectangle_TypeError:
        const char* overloads[] = {"PySide.QtGui.QPainter, PySide.QtCore.QRect, PySide.QtGui.QFont, unicode", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate.textRectangle", overloads);
        return 0;
}

static PyObject* Sbk_QItemDelegateFunc_updateEditorGeometry(PyObject* self, PyObject* args)
{
    ::QItemDelegate* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QItemDelegateFunc_updateEditorGeometry_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QItemDelegate*>(cppSelf)->::QItemDelegate::updateEditorGeometry(cppArg0, *cppArg1, *cppArg2) : const_cast<const ::QItemDelegate*>(cppSelf)->updateEditorGeometry(cppArg0, *cppArg1, *cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QItemDelegateFunc_updateEditorGeometry_TypeError:
        const char* overloads[] = {"PySide.QtGui.QWidget, PySide.QtGui.QStyleOptionViewItem, PySide.QtCore.QModelIndex", 0};
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtGui.QItemDelegate.updateEditorGeometry", overloads);
        return 0;
}

static PyMethodDef Sbk_QItemDelegate_methods[] = {
    {"check", (PyCFunction)Sbk_QItemDelegateFunc_check, METH_VARARGS},
    {"createEditor", (PyCFunction)Sbk_QItemDelegateFunc_createEditor, METH_VARARGS},
    {"decoration", (PyCFunction)Sbk_QItemDelegateFunc_decoration, METH_VARARGS},
    {"drawBackground", (PyCFunction)Sbk_QItemDelegateFunc_drawBackground, METH_VARARGS},
    {"drawCheck", (PyCFunction)Sbk_QItemDelegateFunc_drawCheck, METH_VARARGS},
    {"drawDecoration", (PyCFunction)Sbk_QItemDelegateFunc_drawDecoration, METH_VARARGS},
    {"drawDisplay", (PyCFunction)Sbk_QItemDelegateFunc_drawDisplay, METH_VARARGS},
    {"drawFocus", (PyCFunction)Sbk_QItemDelegateFunc_drawFocus, METH_VARARGS},
    {"editorEvent", (PyCFunction)Sbk_QItemDelegateFunc_editorEvent, METH_VARARGS},
    {"eventFilter", (PyCFunction)Sbk_QItemDelegateFunc_eventFilter, METH_VARARGS},
    {"hasClipping", (PyCFunction)Sbk_QItemDelegateFunc_hasClipping, METH_NOARGS},
    {"itemEditorFactory", (PyCFunction)Sbk_QItemDelegateFunc_itemEditorFactory, METH_NOARGS},
    {"paint", (PyCFunction)Sbk_QItemDelegateFunc_paint, METH_VARARGS},
    {"rect", (PyCFunction)Sbk_QItemDelegateFunc_rect, METH_VARARGS},
    {"setClipping", (PyCFunction)Sbk_QItemDelegateFunc_setClipping, METH_O},
    {"setEditorData", (PyCFunction)Sbk_QItemDelegateFunc_setEditorData, METH_VARARGS},
    {"setItemEditorFactory", (PyCFunction)Sbk_QItemDelegateFunc_setItemEditorFactory, METH_O},
    {"setModelData", (PyCFunction)Sbk_QItemDelegateFunc_setModelData, METH_VARARGS},
    {"setOptions", (PyCFunction)Sbk_QItemDelegateFunc_setOptions, METH_VARARGS},
    {"sizeHint", (PyCFunction)Sbk_QItemDelegateFunc_sizeHint, METH_VARARGS},
    {"textRectangle", (PyCFunction)Sbk_QItemDelegateFunc_textRectangle, METH_VARARGS},
    {"updateEditorGeometry", (PyCFunction)Sbk_QItemDelegateFunc_updateEditorGeometry, METH_VARARGS},
...
static int Sbk_QItemDelegate_traverse(PyObject* self, visitproc visit, void* arg)
{
    return reinterpret_cast<PyTypeObject*>(&SbkObject_Type)->tp_traverse(self, visit, arg);
}
static int Sbk_QItemDelegate_clear(PyObject* self)
{
    return reinterpret_cast<PyTypeObject*>(&SbkObject_Type)->tp_clear(self);
}
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QItemDelegate_Type = { { {
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QItemDelegate_traverse,
    /*tp_clear*/            Sbk_QItemDelegate_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QItemDelegate_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
    /*tp_base*/             0,
    /*tp_dict*/             0,
    ...
    /*tp_descr_set*/        0,
    /*tp_dictoffset*/       0,
    /*tp_init*/             Sbk_QItemDelegate_Init,
    /*tp_alloc*/            0,
...
static void* Sbk_QItemDelegate_typeDiscovery(void* cptr, SbkObjectType* instanceType)
{
    if (instanceType == reinterpret_cast<SbkObjectType*>(Shiboken::SbkType< ::QObject >()))
        return dynamic_cast< ::QItemDelegate*>(reinterpret_cast< ::QObject*>(cptr));
    return 0;
}
...
static void QItemDelegate_PythonToCpp_QItemDelegate_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QItemDelegate_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QItemDelegate_PythonToCpp_QItemDelegate_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QItemDelegate_Type))
        return QItemDelegate_PythonToCpp_QItemDelegate_PTR;
    return 0;
}

// C++ to Python pointer conversion - tries to find the Python wrapper for the C++ object (keeps object identity).
static PyObject* QItemDelegate_PTR_CppToPython_QItemDelegate(const void* cppIn) {
    return PySide::getWrapperForQObject((::QItemDelegate*)cppIn, &Sbk_QItemDelegate_Type);

}

void init_QItemDelegate(PyObject* module)
{
    SbkPySide_QtGuiTypes[SBK_QITEMDELEGATE_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QItemDelegate_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QItemDelegate", "QItemDelegate*",
        &Sbk_QItemDelegate_Type, &Shiboken::callCppDestructor< ::QItemDelegate >, (SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QABSTRACTITEMDELEGATE_IDX])) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QItemDelegate_Type,
        QItemDelegate_PythonToCpp_QItemDelegate_PTR,
        is_QItemDelegate_PythonToCpp_QItemDelegate_PTR_Convertible,
        QItemDelegate_PTR_CppToPython_QItemDelegate);

    Shiboken::Conversions::registerConverterName(converter, "QItemDelegate");
    Shiboken::Conversions::registerConverterName(converter, "QItemDelegate*");
    Shiboken::Conversions::registerConverterName(converter, "QItemDelegate&");
    Shiboken::Conversions::registerConverterName(converter, typeid(::QItemDelegate).name());
    Shiboken::Conversions::registerConverterName(converter, typeid(::QItemDelegateWrapper).name());


    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(&Sbk_QItemDelegate_Type, &Sbk_QItemDelegate_typeDiscovery);

    PySide::Signal::registerSignals(&Sbk_QItemDelegate_Type, &::QItemDelegate::staticMetaObject);

    Shiboken::ObjectType::setSubTypeInitHook(&Sbk_QItemDelegate_Type, &PySide::initQObjectSubType);
    PySide::initDynamicMetaObject(&Sbk_QItemDelegate_Type, &::QItemDelegate::staticMetaObject, sizeof(::QItemDelegate));
}
