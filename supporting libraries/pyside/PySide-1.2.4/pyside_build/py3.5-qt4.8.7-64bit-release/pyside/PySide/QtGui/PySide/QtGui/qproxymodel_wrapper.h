...
#ifndef SBK_QPROXYMODELWRAPPER_H
#define SBK_QPROXYMODELWRAPPER_H
...
class QProxyModelWrapper : public QProxyModel
{
public:
    QProxyModelWrapper(QObject * parent = 0);
    ...
    virtual ~QProxyModelWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline QObject * parent() const { return QProxyModel::parent(); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QPROXYMODELWRAPPER_H
