...
#define SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                     729
...
#define SBK_QFONT_HINTINGPREFERENCE_IDX                              728
...
#define SBK_QPIXMAP_SHAREMODE_IDX                                    380
...
#define SBK_QX11EMBEDCONTAINER_IDX                                   723
#define SBK_QX11EMBEDCONTAINER_ERROR_IDX                             724
#define SBK_QX11EMBEDWIDGET_IDX                                      725
#define SBK_QX11EMBEDWIDGET_ERROR_IDX                                726
...
#define SBK_QtGui_IDX_COUNT                                          730
...
// Converter indices
#define SBK_QTGUI_QLIST_QBYTEARRAY_IDX                               0 // QList<QByteArray >
...
#define SBK_QTGUI_QLIST_QTREEWIDGETITEMPTR_IDX                       3 // const QList<QTreeWidgetItem * > &
#define SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                         4 // const QList<QStandardItem * > &
#define SBK_QTGUI_QLIST_QITEMSELECTIONRANGE_IDX                      5 // const QList<QItemSelectionRange > &
#define SBK_QTGUI_QSET_QITEMSELECTIONRANGE_IDX                       6 // const QSet<QItemSelectionRange > &
#define SBK_QTGUI_QVECTOR_QITEMSELECTIONRANGE_IDX                    7 // const QVector<QItemSelectionRange > &
#define SBK_QTGUI_QVECTOR_QTEXTLENGTH_IDX                            8 // QVector<QTextLength >
#define SBK_QTGUI_QMAP_INT_QVARIANT_IDX                              9 // QMap<int, QVariant >
#define SBK_QTGUI_QLIST_QTEXTOPTION_TAB_IDX                          10 // const QList<QTextOption::Tab > &
#define SBK_QTGUI_QLIST_QPRINTERINFO_IDX                             11 // QList<QPrinterInfo >
#define SBK_QTGUI_QLIST_QPRINTER_PAGESIZE_IDX                        12 // QList<QPrinter::PageSize >
#define SBK_QTGUI_QLIST_QREAL_IDX                                    13 // QList<qreal >
#define SBK_QTGUI_QVECTOR_QREAL_IDX                                  14 // QVector<qreal >
#define SBK_QTGUI_QPAIR_QREAL_QCOLOR_IDX                             15 // QPair<qreal, QColor >
#define SBK_QTGUI_QVECTOR_QPAIR_QREAL_QCOLOR_IDX                     16 // const QVector<QPair<qreal, QColor > > &
#define SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                             17 // QList<QKeySequence >
#define SBK_QTGUI_QLIST_QPOLYGONF_IDX                                18 // QList<QPolygonF >
#define SBK_QTGUI_QVECTOR_QPOINTF_IDX                                19 // const QVector<QPointF > &
#define SBK_QTGUI_QLIST_QPOINTF_IDX                                  20 // const QList<QPointF > &
#define SBK_QTGUI_QVECTOR_QPOINT_IDX                                 21 // const QVector<QPoint > &
#define SBK_QTGUI_QLIST_QPOINT_IDX                                   22 // const QList<QPoint > &
#define SBK_QTGUI_QLIST_QTOUCHEVENT_TOUCHPOINT_IDX                   23 // const QList<QTouchEvent::TouchPoint > &
#define SBK_QTGUI_QLIST_QGESTUREPTR_IDX                              24 // const QList<QGesture * > &
#define SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX              25 // const QList<QInputMethodEvent::Attribute > &
#define SBK_QTGUI_QLIST_QTEXTLAYOUT_FORMATRANGE_IDX                  26 // QList<QTextLayout::FormatRange >
#define SBK_QTGUI_QVECTOR_QTEXTLAYOUT_FORMATRANGE_IDX                27 // const QVector<QTextLayout::FormatRange > &
#define SBK_QTGUI_QVECTOR_UNSIGNEDINT_IDX                            28 // QVector<unsigned int >
...
#define SBK_QTGUI_QLIST_QSIZE_IDX                                    31 // QList<QSize >
#define SBK_QTGUI_QVECTOR_QLINE_IDX                                  32 // const QVector<QLine > &
#define SBK_QTGUI_QVECTOR_QLINEF_IDX                                 33 // const QVector<QLineF > &
#define SBK_QTGUI_QVECTOR_QRECT_IDX                                  34 // const QVector<QRect > &
#define SBK_QTGUI_QVECTOR_QRECTF_IDX                                 35 // const QVector<QRectF > &
#define SBK_QTGUI_QLIST_QOBJECTPTR_IDX                               36 // const QList<QObject * > &
#define SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                            37 // QList<QUndoStack * >
#define SBK_QTGUI_QLIST_QACTIONPTR_IDX                               38 // QList<QAction * >
#define SBK_QTGUI_QLIST_QRECTF_IDX                                   39 // const QList<QRectF > &
#define SBK_QTGUI_QLIST_QGRAPHICSVIEWPTR_IDX                         40 // QList<QGraphicsView * >
#define SBK_QTGUI_QPAIR_QREAL_QPOINTF_IDX                            41 // QPair<qreal, QPointF >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QPOINTF_IDX                      42 // QList<QPair<qreal, QPointF > >
#define SBK_QTGUI_QPAIR_QREAL_QREAL_IDX                              43 // QPair<qreal, qreal >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QREAL_IDX                        44 // QList<QPair<qreal, qreal > >
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           45 // const QHash<int, QByteArray > &
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            46 // QList<QTextFrame * >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               47 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QWIDGETPTR_IDX                               48 // QList<QWidget * >
#define SBK_QTGUI_QLIST_QABSTRACTANIMATIONPTR_IDX                    49 // QList<QAbstractAnimation * >
#define SBK_QTGUI_QLIST_QABSTRACTSTATEPTR_IDX                        50 // const QList<QAbstractState * > &
#define SBK_QTGUI_QLIST_QGRAPHICSWIDGETPTR_IDX                       51 // QList<QGraphicsWidget * >
#define SBK_QTGUI_QLIST_QLISTWIDGETITEMPTR_IDX                       52 // QList<QListWidgetItem * >
#define SBK_QTGUI_QLIST_QTABLEWIDGETITEMPTR_IDX                      53 // QList<QTableWidgetItem * >
#define SBK_QTGUI_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX               54 // QList<QTableWidgetSelectionRange >
#define SBK_QTGUI_QLIST_QTEXTEDIT_EXTRASELECTION_IDX                 55 // QList<QTextEdit::ExtraSelection >
#define SBK_QTGUI_QLIST_QMDISUBWINDOWPTR_IDX                         56 // QList<QMdiSubWindow * >
#define SBK_QTGUI_QLIST_QDOCKWIDGETPTR_IDX                           57 // QList<QDockWidget * >
#define SBK_QTGUI_QLIST_QWIZARD_WIZARDBUTTON_IDX                     58 // const QList<QWizard::WizardButton > &
#define SBK_QTGUI_QLIST_QABSTRACTBUTTONPTR_IDX                       59 // QList<QAbstractButton * >
#define SBK_QTGUI_QMAP_QDATE_QTEXTCHARFORMAT_IDX                     60 // QMap<QDate, QTextCharFormat >
#define SBK_QTGUI_QLIST_QURL_IDX                                     61 // const QList<QUrl > &
#define SBK_QTGUI_QVECTOR_QTEXTFORMAT_IDX                            62 // QVector<QTextFormat >
#define SBK_QTGUI_QLIST_QVARIANT_IDX                                 63 // QList<QVariant >
#define SBK_QTGUI_QLIST_QSTRING_IDX                                  64 // QList<QString >
#define SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                          65 // QMap<QString, QVariant >
#define SBK_QtGui_CONVERTERS_IDX_COUNT                               66
