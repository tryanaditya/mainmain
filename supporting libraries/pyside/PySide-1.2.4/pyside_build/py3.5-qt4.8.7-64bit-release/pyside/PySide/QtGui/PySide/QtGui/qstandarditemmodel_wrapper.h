...
#ifndef SBK_QSTANDARDITEMMODELWRAPPER_H
#define SBK_QSTANDARDITEMMODELWRAPPER_H
...
public:
    ...
    virtual ~QStandardItemModelWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline QObject * parent() const { return QStandardItemModel::parent(); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QSTANDARDITEMMODELWRAPPER_H
