...
#ifndef SBK_QABSTRACTITEMVIEWWRAPPER_H
#define SBK_QABSTRACTITEMVIEWWRAPPER_H
...
class QAbstractItemViewWrapper : public QAbstractItemView
{
public:
    ...
    virtual ~QAbstractItemViewWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline void edit(const QModelIndex & index) { QAbstractItemView::edit(index); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QABSTRACTITEMVIEWWRAPPER_H
