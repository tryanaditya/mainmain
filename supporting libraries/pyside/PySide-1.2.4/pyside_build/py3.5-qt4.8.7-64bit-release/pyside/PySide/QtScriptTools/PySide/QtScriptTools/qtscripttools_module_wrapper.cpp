...
PyTypeObject** SbkPySide_QtScriptToolsTypes;
// Current module's converter array.
SbkConverter** SbkPySide_QtScriptToolsTypeConverters;
void cleanTypesAttributes(void) {
    for (int i = 0, imax = SBK_QtScriptTools_IDX_COUNT; i < imax; i++) {
        PyObject *pyType = reinterpret_cast<PyObject*>(SbkPySide_QtScriptToolsTypes[i]);
...
static PyMethodDef QtScriptTools_methods[] = {
    {0} // Sentinel
};
...
static struct PyModuleDef moduledef = {
    ...
    /* m_name     */ "QtScriptTools",
    /* m_doc      */ 0,
    /* m_size     */ -1,
    /* m_methods  */ QtScriptTools_methods,
    /* m_reload   */ 0,
    /* m_traverse */ 0,
    /* m_clear    */ 0,
    /* m_free     */ 0
...
#endif
SBK_MODULE_INIT_FUNCTION_BEGIN(QtScriptTools)
    {
        Shiboken::AutoDecRef requiredModule(Shiboken::Module::import("PySide.QtScript"));
        if (requiredModule.isNull())
            return SBK_MODULE_INIT_ERROR;
        SbkPySide_QtScriptTypes = Shiboken::Module::getTypes(requiredModule);
        SbkPySide_QtScriptTypeConverters = Shiboken::Module::getTypeConverters(requiredModule);
    }
    ...
    static PyTypeObject* cppApi[SBK_QtScriptTools_IDX_COUNT];
    SbkPySide_QtScriptToolsTypes = cppApi;

    // Create an array of primitive type converters for the current module.
    static SbkConverter* sbkConverters[SBK_QtScriptTools_CONVERTERS_IDX_COUNT];
    SbkPySide_QtScriptToolsTypeConverters = sbkConverters;

#ifdef IS_PY3K
    PyObject* module = Shiboken::Module::create("QtScriptTools", &moduledef);
#else
    PyObject* module = Shiboken::Module::create("QtScriptTools", QtScriptTools_methods);
#endif

    // Initialize classes in the type system
    init_QScriptEngineDebugger(module);

    // Register converter for type 'const QList<QObject*>&'.
    SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QOBJECTPTR_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _constQList_QObjectPTR_REF_CppToPython__constQList_QObjectPTR_REF);
    Shiboken::Conversions::registerConverterName(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QOBJECTPTR_IDX], "const QList<QObject*>&");
    Shiboken::Conversions::registerConverterName(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QOBJECTPTR_IDX], "QList<QObject*>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QOBJECTPTR_IDX],
    ...
    SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QBYTEARRAY_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QByteArray__CppToPython__QList_QByteArray_);
    Shiboken::Conversions::registerConverterName(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QBYTEARRAY_IDX], "QList<QByteArray>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QBYTEARRAY_IDX],
    ...
    SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkPySide_QtScriptToolsTypeConverters[SBK_QTSCRIPTTOOLS_QMAP_QSTRING_QVARIANT_IDX],
    ...
    Shiboken::Module::registerTypes(module, SbkPySide_QtScriptToolsTypes);
    Shiboken::Module::registerTypeConverters(module, SbkPySide_QtScriptToolsTypeConverters);

    if (PyErr_Occurred()) {
        PyErr_Print();
        Py_FatalError("can't initialize module QtScriptTools");
    }
