...
static void QtValidLicenseForOpenVGModule_PythonToCpp_QtValidLicenseForOpenVGModule(PyObject* pyIn, void* cppOut) {
    *((::QtValidLicenseForOpenVGModule*)cppOut) = (::QtValidLicenseForOpenVGModule) Shiboken::Enum::getValue(pyIn);

}
static PythonToCppFunc is_QtValidLicenseForOpenVGModule_PythonToCpp_QtValidLicenseForOpenVGModule_Convertible(PyObject* pyIn) {
    if (PyObject_TypeCheck(pyIn, SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX]))
        return QtValidLicenseForOpenVGModule_PythonToCpp_QtValidLicenseForOpenVGModule;
    return 0;
}
static PyObject* QtValidLicenseForOpenVGModule_CppToPython_QtValidLicenseForOpenVGModule(const void* cppIn) {
    int castCppIn = *((::QtValidLicenseForOpenVGModule*)cppIn);
    return Shiboken::Enum::newItem(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX], castCppIn);

}


static void QtValidLicenseForMultimediaModule_PythonToCpp_QtValidLicenseForMultimediaModule(PyObject* pyIn, void* cppOut) {
    *((::QtValidLicenseForMultimediaModule*)cppOut) = (::QtValidLicenseForMultimediaModule) Shiboken::Enum::getValue(pyIn);

}
static PythonToCppFunc is_QtValidLicenseForMultimediaModule_PythonToCpp_QtValidLicenseForMultimediaModule_Convertible(PyObject* pyIn) {
    if (PyObject_TypeCheck(pyIn, SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX]))
        return QtValidLicenseForMultimediaModule_PythonToCpp_QtValidLicenseForMultimediaModule;
    return 0;
}
static PyObject* QtValidLicenseForMultimediaModule_CppToPython_QtValidLicenseForMultimediaModule(const void* cppIn) {
    int castCppIn = *((::QtValidLicenseForMultimediaModule*)cppIn);
    return Shiboken::Enum::newItem(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX], castCppIn);

}


static void QtValidLicenseForDeclarativeModule_PythonToCpp_QtValidLicenseForDeclarativeModule(PyObject* pyIn, void* cppOut) {
    *((::QtValidLicenseForDeclarativeModule*)cppOut) = (::QtValidLicenseForDeclarativeModule) Shiboken::Enum::getValue(pyIn);

}
static PythonToCppFunc is_QtValidLicenseForDeclarativeModule_PythonToCpp_QtValidLicenseForDeclarativeModule_Convertible(PyObject* pyIn) {
    if (PyObject_TypeCheck(pyIn, SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX]))
        return QtValidLicenseForDeclarativeModule_PythonToCpp_QtValidLicenseForDeclarativeModule;
    return 0;
}
static PyObject* QtValidLicenseForDeclarativeModule_CppToPython_QtValidLicenseForDeclarativeModule(const void* cppIn) {
    int castCppIn = *((::QtValidLicenseForDeclarativeModule*)cppIn);
    return Shiboken::Enum::newItem(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX], castCppIn);
...
SBK_MODULE_INIT_FUNCTION_BEGIN(QtCore)
    ...
    // Initialization of enum 'QtValidLicenseForOpenVGModule'.
    SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX] = Shiboken::Enum::createGlobalEnum(module,
        "QtValidLicenseForOpenVGModule",
        "PySide.QtCore.QtValidLicenseForOpenVGModule",
        "QtValidLicenseForOpenVGModule");
    if (!SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX])
        return SBK_MODULE_INIT_ERROR;

    if (!Shiboken::Enum::createGlobalEnumItem(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX],
        module, "LicensedOpenVG", (long) LicensedOpenVG))
        return SBK_MODULE_INIT_ERROR;
    // Register converter for enum 'QtValidLicenseForOpenVGModule'.
    {
        SbkConverter* converter = Shiboken::Conversions::createConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX],
            QtValidLicenseForOpenVGModule_CppToPython_QtValidLicenseForOpenVGModule);
        Shiboken::Conversions::addPythonToCppValueConversion(converter,
            QtValidLicenseForOpenVGModule_PythonToCpp_QtValidLicenseForOpenVGModule,
            is_QtValidLicenseForOpenVGModule_PythonToCpp_QtValidLicenseForOpenVGModule_Convertible);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX], converter);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFOROPENVGMODULE_IDX], converter);
        Shiboken::Conversions::registerConverterName(converter, "QtValidLicenseForOpenVGModule");
    }
    // End of 'QtValidLicenseForOpenVGModule' enum.

    // Initialization of enum 'QtValidLicenseForMultimediaModule'.
    SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX] = Shiboken::Enum::createGlobalEnum(module,
        "QtValidLicenseForMultimediaModule",
        "PySide.QtCore.QtValidLicenseForMultimediaModule",
        "QtValidLicenseForMultimediaModule");
    if (!SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX])
        return SBK_MODULE_INIT_ERROR;

    if (!Shiboken::Enum::createGlobalEnumItem(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX],
        module, "LicensedMultimedia", (long) LicensedMultimedia))
        return SBK_MODULE_INIT_ERROR;
    // Register converter for enum 'QtValidLicenseForMultimediaModule'.
    {
        SbkConverter* converter = Shiboken::Conversions::createConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX],
            QtValidLicenseForMultimediaModule_CppToPython_QtValidLicenseForMultimediaModule);
        Shiboken::Conversions::addPythonToCppValueConversion(converter,
            QtValidLicenseForMultimediaModule_PythonToCpp_QtValidLicenseForMultimediaModule,
            is_QtValidLicenseForMultimediaModule_PythonToCpp_QtValidLicenseForMultimediaModule_Convertible);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX], converter);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORMULTIMEDIAMODULE_IDX], converter);
        Shiboken::Conversions::registerConverterName(converter, "QtValidLicenseForMultimediaModule");
    }
    // End of 'QtValidLicenseForMultimediaModule' enum.

    // Initialization of enum 'QtValidLicenseForDeclarativeModule'.
    SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX] = Shiboken::Enum::createGlobalEnum(module,
        "QtValidLicenseForDeclarativeModule",
        "PySide.QtCore.QtValidLicenseForDeclarativeModule",
        "QtValidLicenseForDeclarativeModule");
    if (!SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX])
        return SBK_MODULE_INIT_ERROR;

    if (!Shiboken::Enum::createGlobalEnumItem(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX],
        module, "LicensedDeclarative", (long) LicensedDeclarative))
        return SBK_MODULE_INIT_ERROR;
    // Register converter for enum 'QtValidLicenseForDeclarativeModule'.
    {
        SbkConverter* converter = Shiboken::Conversions::createConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX],
            QtValidLicenseForDeclarativeModule_CppToPython_QtValidLicenseForDeclarativeModule);
        Shiboken::Conversions::addPythonToCppValueConversion(converter,
            QtValidLicenseForDeclarativeModule_PythonToCpp_QtValidLicenseForDeclarativeModule,
            is_QtValidLicenseForDeclarativeModule_PythonToCpp_QtValidLicenseForDeclarativeModule_Convertible);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX], converter);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTVALIDLICENSEFORDECLARATIVEMODULE_IDX], converter);
        Shiboken::Conversions::registerConverterName(converter, "QtValidLicenseForDeclarativeModule");
    }
    // End of 'QtValidLicenseForDeclarativeModule' enum.
    ...
    qRegisterMetaType< ::QtValidLicenseForOpenVGModule >("QtValidLicenseForOpenVGModule");
    qRegisterMetaType< ::QtValidLicenseForMultimediaModule >("QtValidLicenseForMultimediaModule");
    qRegisterMetaType< ::QtValidLicenseForDeclarativeModule >("QtValidLicenseForDeclarativeModule");
