...
Sbk_QUuid_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    Sbk_QUuid_Init_TypeError:
        const char* overloads[] = {"", "PySide.QtCore.QByteArray", "unicode", "PySide.QtCore.QUuid", "" SBK_STR_NAME "", "unsigned int, unsigned short, unsigned short, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char", 0};
