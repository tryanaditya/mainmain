...
Sbk_QReadLocker_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    Sbk_QReadLocker_Init_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtCore.QReadLocker", overloads);
        return -1;
}

static PyObject* Sbk_QReadLockerFunc___enter__(PyObject* self)
{
    ::QReadLocker* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QReadLocker*)Shiboken::Conversions::cppPointer(SbkPySide_QtCoreTypes[SBK_QREADLOCKER_IDX], (SbkObject*)self));
...
static PyObject* Sbk_QReadLockerFunc___exit__(PyObject* self, PyObject* args)
{
    ...
    Sbk_QReadLockerFunc___exit___TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtCore.QReadLocker.__exit__", overloads);
        return 0;
}
...
static PyMethodDef Sbk_QReadLocker_methods[] = {
    {"__enter__", (PyCFunction)Sbk_QReadLockerFunc___enter__, METH_NOARGS},
    {"__exit__", (PyCFunction)Sbk_QReadLockerFunc___exit__, METH_VARARGS},
    {"readWriteLock", (PyCFunction)Sbk_QReadLockerFunc_readWriteLock, METH_NOARGS},
    {"relock", (PyCFunction)Sbk_QReadLockerFunc_relock, METH_NOARGS},
    {"unlock", (PyCFunction)Sbk_QReadLockerFunc_unlock, METH_NOARGS},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QReadLocker_Type = { { {
    PyVarObject_HEAD_INIT(&SbkObjectType_Type, 0)
    /*tp_name*/             "PySide.QtCore.QReadLocker",
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QReadLocker_traverse,
    /*tp_clear*/            Sbk_QReadLocker_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QReadLocker_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
...
static void QReadLocker_PythonToCpp_QReadLocker_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QReadLocker_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QReadLocker_PythonToCpp_QReadLocker_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QReadLocker_Type))
...
static PyObject* QReadLocker_PTR_CppToPython_QReadLocker(const void* cppIn) {
    ...
    const char* typeName = typeid(*((::QReadLocker*)cppIn)).name();
    return Shiboken::Object::newObject(&Sbk_QReadLocker_Type, const_cast<void*>(cppIn), false, false, typeName);
}

void init_QReadLocker(PyObject* module)
{
    SbkPySide_QtCoreTypes[SBK_QREADLOCKER_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QReadLocker_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QReadLocker", "QReadLocker*",
        &Sbk_QReadLocker_Type, &Shiboken::callCppDestructor< ::QReadLocker >)) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QReadLocker_Type,
