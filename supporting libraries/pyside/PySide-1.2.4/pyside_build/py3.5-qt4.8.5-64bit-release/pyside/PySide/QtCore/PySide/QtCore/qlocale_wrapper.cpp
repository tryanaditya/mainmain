...
static PyObject* Sbk_QLocaleFunc_toCurrencyString(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    Sbk_QLocaleFunc_toCurrencyString_TypeError:
        const char* overloads[] = {"float, unicode = QString()", "float, unicode = QString()", "int, unicode = QString()", "long long, unicode = QString()", "unsigned long long, unicode = QString()", "short, unicode = QString()", "unsigned int, unicode = QString()", "unsigned short int, unicode = QString()", 0};
