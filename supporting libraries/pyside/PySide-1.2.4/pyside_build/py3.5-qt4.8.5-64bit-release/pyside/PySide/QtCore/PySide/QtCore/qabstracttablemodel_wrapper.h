...
#ifndef SBK_QABSTRACTTABLEMODELWRAPPER_H
#define SBK_QABSTRACTTABLEMODELWRAPPER_H
...
{
public:
    QAbstractTableModelWrapper(QObject * parent = 0);
    ...
    virtual ~QAbstractTableModelWrapper();
public:
...
#endif // SBK_QABSTRACTTABLEMODELWRAPPER_H
