...
bool QThreadWrapper::event(QEvent * arg__1)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QThread.event", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
...
bool QThreadWrapper::eventFilter(QObject * arg__1, QEvent * arg__2)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QThread.eventFilter", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
Sbk_QThread_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread(): got multiple values for keyword argument 'parent'.");
                return -1;
            } else if (value) {
                pyArgs[0] = value;
...
static PyObject* Sbk_QThreadFunc_currentThreadId(PyObject* self)
{
    PyObject* pyResult = 0;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // currentThreadId()
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Qt::HANDLE cppResult = ::QThread::currentThreadId();
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
...
static PyObject* Sbk_QThreadFunc_exec_(PyObject* self)
{
    ...
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QThread*)Shiboken::Conversions::cppPointer(SbkPySide_QtCoreTypes[SBK_QTHREAD_IDX], (SbkObject*)self));
    PyObject* pyResult = 0;
...
static PyObject* Sbk_QThreadFunc_exit(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.exit(): too many arguments");
        return 0;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.exit(): got multiple values for keyword argument 'retcode'.");
                return 0;
            } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QThreadFunc_exit_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtCore.QThread.exit", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_msleep(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QThreadFunc_msleep_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtCore.QThread.msleep", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_priority(PyObject* self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython(SBK_CONVERTER(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX]), &cppResult);
        }
    }
...
static PyObject* Sbk_QThreadFunc_run(PyObject* self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // run()
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? cppSelf->::QThread::run() : cppSelf->run();
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
...
static PyObject* Sbk_QThreadFunc_setPriority(PyObject* self, PyObject* pyArg)
{
    ...
    // Overloaded function decisor
    // 0: setPriority(QThread::Priority)
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX]), (pyArg)))) {
    ...
    // Call function/method
    {
        ::QThread::Priority cppArg0 = ((::QThread::Priority)0);
        pythonToCpp(pyArg, &cppArg0);
    ...
    Sbk_QThreadFunc_setPriority_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtCore.QThread.setPriority", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_setStackSize(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QThreadFunc_setStackSize_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtCore.QThread.setStackSize", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_setTerminationEnabled(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // invalid argument lengths
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.setTerminationEnabled(): too many arguments");
        return 0;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.setTerminationEnabled(): got multiple values for keyword argument 'enabled'.");
                return 0;
            } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QThreadFunc_setTerminationEnabled_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtCore.QThread.setTerminationEnabled", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_sleep(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QThreadFunc_sleep_TypeError:
        const char* overloads[] = {"unsigned long", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtCore.QThread.sleep", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_start(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // invalid argument lengths
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.start(): too many arguments");
        return 0;
    }
    ...
    // Overloaded function decisor
    // 0: start(QThread::Priority)
    if (numArgs == 0) {
        overloadId = 0; // start(QThread::Priority)
    } else if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX]), (pyArgs[0])))) {
        overloadId = 0; // start(QThread::Priority)
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.start(): got multiple values for keyword argument 'priority'.");
                return 0;
            } else if (value) {
                pyArgs[0] = value;
                if (!(pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(SBK_CONVERTER(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX]), (pyArgs[0]))))
                    goto Sbk_QThreadFunc_start_TypeError;
            }
        }
        ::QThread::Priority cppArg0 = QThread::InheritPriority;
        if (pythonToCpp[0]) pythonToCpp[0](pyArgs[0], &cppArg0);
    ...
    Sbk_QThreadFunc_start_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtCore.QThread.start", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_usleep(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QThreadFunc_usleep_TypeError:
        const char* overloads[] = {"unsigned long", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtCore.QThread.usleep", overloads);
        return 0;
}
...
static PyObject* Sbk_QThreadFunc_wait(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // invalid argument lengths
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.wait(): too many arguments");
        return 0;
    }
    ...
    // 0: wait(ulong)
    if (numArgs == 0) {
        overloadId = 0; // wait(ulong)
    } else if ((pythonToCpp[0] = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<unsigned long>(), (pyArgs[0])))) {
        overloadId = 0; // wait(ulong)
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "PySide.QtCore.QThread.wait(): got multiple values for keyword argument 'time'.");
                return 0;
            } else if (value) {
                pyArgs[0] = value;
        ...
        unsigned long cppArg0 = 4294967295UL;
        if (pythonToCpp[0]) pythonToCpp[0](pyArgs[0], &cppArg0);
    ...
    Sbk_QThreadFunc_wait_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtCore.QThread.wait", overloads);
        return 0;
}
...
static PyMethodDef Sbk_QThread_methods[] = {
    {"currentThread", (PyCFunction)Sbk_QThreadFunc_currentThread, METH_NOARGS|METH_STATIC},
    {"currentThreadId", (PyCFunction)Sbk_QThreadFunc_currentThreadId, METH_NOARGS|METH_STATIC},
    {"exec_", (PyCFunction)Sbk_QThreadFunc_exec_, METH_NOARGS},
    {"exit", (PyCFunction)Sbk_QThreadFunc_exit, METH_VARARGS|METH_KEYWORDS},
    {"idealThreadCount", (PyCFunction)Sbk_QThreadFunc_idealThreadCount, METH_NOARGS|METH_STATIC},
    {"isFinished", (PyCFunction)Sbk_QThreadFunc_isFinished, METH_NOARGS},
    {"isRunning", (PyCFunction)Sbk_QThreadFunc_isRunning, METH_NOARGS},
    {"msleep", (PyCFunction)Sbk_QThreadFunc_msleep, METH_O|METH_STATIC},
    {"priority", (PyCFunction)Sbk_QThreadFunc_priority, METH_NOARGS},
    {"quit", (PyCFunction)Sbk_QThreadFunc_quit, METH_NOARGS},
    {"run", (PyCFunction)Sbk_QThreadFunc_run, METH_NOARGS},
    {"setPriority", (PyCFunction)Sbk_QThreadFunc_setPriority, METH_O},
    {"setStackSize", (PyCFunction)Sbk_QThreadFunc_setStackSize, METH_O},
    {"setTerminationEnabled", (PyCFunction)Sbk_QThreadFunc_setTerminationEnabled, METH_VARARGS|METH_KEYWORDS|METH_STATIC},
    {"sleep", (PyCFunction)Sbk_QThreadFunc_sleep, METH_O|METH_STATIC},
    {"stackSize", (PyCFunction)Sbk_QThreadFunc_stackSize, METH_NOARGS},
    {"start", (PyCFunction)Sbk_QThreadFunc_start, METH_VARARGS|METH_KEYWORDS},
    {"terminate", (PyCFunction)Sbk_QThreadFunc_terminate, METH_NOARGS},
    {"usleep", (PyCFunction)Sbk_QThreadFunc_usleep, METH_O|METH_STATIC},
    {"wait", (PyCFunction)Sbk_QThreadFunc_wait, METH_VARARGS|METH_KEYWORDS},
    {"yieldCurrentThread", (PyCFunction)Sbk_QThreadFunc_yieldCurrentThread, METH_NOARGS|METH_STATIC},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QThread_Type = { { {
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QThread_traverse,
    /*tp_clear*/            Sbk_QThread_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QThread_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
    /*tp_base*/             0,
    /*tp_dict*/             0,
...
static void QThread_Priority_PythonToCpp_QThread_Priority(PyObject* pyIn, void* cppOut) {
    *((::QThread::Priority*)cppOut) = (::QThread::Priority) Shiboken::Enum::getValue(pyIn);

}
static PythonToCppFunc is_QThread_Priority_PythonToCpp_QThread_Priority_Convertible(PyObject* pyIn) {
    if (PyObject_TypeCheck(pyIn, SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX]))
...
static PyObject* QThread_Priority_CppToPython_QThread_Priority(const void* cppIn) {
    int castCppIn = *((::QThread::Priority*)cppIn);
    return Shiboken::Enum::newItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX], castCppIn);

}

// Python to C++ pointer conversion - returns the C++ object of the Python wrapper (keeps object identity).
static void QThread_PythonToCpp_QThread_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QThread_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QThread_PythonToCpp_QThread_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QThread_Type))
...
static PyObject* QThread_PTR_CppToPython_QThread(const void* cppIn) {
    return PySide::getWrapperForQObject((::QThread*)cppIn, &Sbk_QThread_Type);

}

void init_QThread(PyObject* module)
{
    SbkPySide_QtCoreTypes[SBK_QTHREAD_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QThread_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QThread", "QThread*",
        &Sbk_QThread_Type, &Shiboken::callCppDestructor< ::QThread >, (SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QOBJECT_IDX])) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QThread_Type,
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(&Sbk_QThread_Type, &Sbk_QThread_typeDiscovery);

    // Initialization of enums.

    // Initialization of enum 'Priority'.
    SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX] = Shiboken::Enum::createScopedEnum(&Sbk_QThread_Type,
        "Priority",
        "PySide.QtCore.QThread.Priority",
        "QThread::Priority");
    if (!SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX])
        return ;

    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "IdlePriority", (long) QThread::IdlePriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "LowestPriority", (long) QThread::LowestPriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "LowPriority", (long) QThread::LowPriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "NormalPriority", (long) QThread::NormalPriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "HighPriority", (long) QThread::HighPriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "HighestPriority", (long) QThread::HighestPriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "TimeCriticalPriority", (long) QThread::TimeCriticalPriority))
        return ;
    if (!Shiboken::Enum::createScopedEnumItem(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        &Sbk_QThread_Type, "InheritPriority", (long) QThread::InheritPriority))
        return ;
    // Register converter for enum 'QThread::Priority'.
    {
        SbkConverter* converter = Shiboken::Conversions::createConverter(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX],
        ...
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX], converter);
        Shiboken::Enum::setTypeConverter(SbkPySide_QtCoreTypes[SBK_QTHREAD_PRIORITY_IDX], converter);
    ...
    PySide::Signal::registerSignals(&Sbk_QThread_Type, &::QThread::staticMetaObject);

    qRegisterMetaType< ::QThread::Priority >("QThread::Priority");
    Shiboken::ObjectType::setSubTypeInitHook(&Sbk_QThread_Type, &PySide::initQObjectSubType);
    PySide::initDynamicMetaObject(&Sbk_QThread_Type, &::QThread::staticMetaObject, sizeof(::QThread));
}
