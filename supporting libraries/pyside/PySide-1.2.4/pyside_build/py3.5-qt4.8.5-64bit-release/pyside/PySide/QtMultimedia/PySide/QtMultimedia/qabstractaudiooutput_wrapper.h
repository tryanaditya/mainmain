...
#ifndef SBK_QABSTRACTAUDIOOUTPUTWRAPPER_H
#define SBK_QABSTRACTAUDIOOUTPUTWRAPPER_H
...
class QAbstractAudioOutputWrapper : public QAbstractAudioOutput
{
public:
    QAbstractAudioOutputWrapper();
    ...
    virtual QIODevice * start(QIODevice * device);
    virtual QAudio::State state() const;
    virtual void stop();
    virtual void suspend();
    virtual void timerEvent(QTimerEvent * arg__1);
    virtual ~QAbstractAudioOutputWrapper();
public:
...
#endif // SBK_QABSTRACTAUDIOOUTPUTWRAPPER_H
