...
#ifndef SBK_QABSTRACTAUDIOINPUTWRAPPER_H
#define SBK_QABSTRACTAUDIOINPUTWRAPPER_H
...
class QAbstractAudioInputWrapper : public QAbstractAudioInput
{
public:
    QAbstractAudioInputWrapper();
    ...
    virtual ~QAbstractAudioInputWrapper();
public:
...
#endif // SBK_QABSTRACTAUDIOINPUTWRAPPER_H
