...
bool QAudioInputWrapper::event(QEvent * arg__1)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QAudioInput.event", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
...
bool QAudioInputWrapper::eventFilter(QObject * arg__1, QEvent * arg__2)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QAudioInput.eventFilter", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
Sbk_QAudioInput_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // 0: QAudioInput(QAudioDeviceInfo,QAudioFormat,QObject*)
    // 1: QAudioInput(QAudioFormat,QObject*)
    if (numArgs == 0) {
    ...
    switch (overloadId) {
        case 0: // QAudioInput(const QAudioDeviceInfo & audioDeviceInfo, const QAudioFormat & format, QObject * parent)
        {
            if (kwds) {
                ...
                if (value && pyArgs[1]) {
                    PyErr_SetString(PyExc_TypeError, "PySide.QtMultimedia.QAudioInput(): got multiple values for keyword argument 'format'.");
                    return -1;
                } else if (value) {
                    pyArgs[1] = value;
                ...
                if (value && pyArgs[2]) {
                    PyErr_SetString(PyExc_TypeError, "PySide.QtMultimedia.QAudioInput(): got multiple values for keyword argument 'parent'.");
                    return -1;
                } else if (value) {
                    pyArgs[2] = value;
...
{
    ::QAudioInput* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QAudioInput*)Shiboken::Conversions::cppPointer(SbkPySide_QtMultimediaTypes[SBK_QAUDIOINPUT_IDX], (SbkObject*)self));
    PyObject* pyResult = 0;
...
static PyObject* Sbk_QAudioInputFunc_setBufferSize(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QAudioInputFunc_setBufferSize_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtMultimedia.QAudioInput.setBufferSize", overloads);
        return 0;
}
...
static PyObject* Sbk_QAudioInputFunc_setNotifyInterval(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QAudioInputFunc_setNotifyInterval_TypeError:
        const char* overloads[] = {"int", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtMultimedia.QAudioInput.setNotifyInterval", overloads);
        return 0;
}
...
static PyObject* Sbk_QAudioInputFunc_start(PyObject* self, PyObject* args)
{
    ...
    Sbk_QAudioInputFunc_start_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "PySide.QtMultimedia.QAudioInput.start", overloads);
        return 0;
}
...
static PyMethodDef Sbk_QAudioInput_methods[] = {
    {"bufferSize", (PyCFunction)Sbk_QAudioInputFunc_bufferSize, METH_NOARGS},
    {"bytesReady", (PyCFunction)Sbk_QAudioInputFunc_bytesReady, METH_NOARGS},
    {"elapsedUSecs", (PyCFunction)Sbk_QAudioInputFunc_elapsedUSecs, METH_NOARGS},
    {"error", (PyCFunction)Sbk_QAudioInputFunc_error, METH_NOARGS},
    {"format", (PyCFunction)Sbk_QAudioInputFunc_format, METH_NOARGS},
    {"notifyInterval", (PyCFunction)Sbk_QAudioInputFunc_notifyInterval, METH_NOARGS},
    {"periodSize", (PyCFunction)Sbk_QAudioInputFunc_periodSize, METH_NOARGS},
    {"processedUSecs", (PyCFunction)Sbk_QAudioInputFunc_processedUSecs, METH_NOARGS},
    {"reset", (PyCFunction)Sbk_QAudioInputFunc_reset, METH_NOARGS},
    {"resume", (PyCFunction)Sbk_QAudioInputFunc_resume, METH_NOARGS},
    {"setBufferSize", (PyCFunction)Sbk_QAudioInputFunc_setBufferSize, METH_O},
    {"setNotifyInterval", (PyCFunction)Sbk_QAudioInputFunc_setNotifyInterval, METH_O},
    {"start", (PyCFunction)Sbk_QAudioInputFunc_start, METH_VARARGS},
    {"state", (PyCFunction)Sbk_QAudioInputFunc_state, METH_NOARGS},
    {"stop", (PyCFunction)Sbk_QAudioInputFunc_stop, METH_NOARGS},
    {"suspend", (PyCFunction)Sbk_QAudioInputFunc_suspend, METH_NOARGS},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QAudioInput_Type = { { {
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QAudioInput_traverse,
    /*tp_clear*/            Sbk_QAudioInput_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QAudioInput_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
    /*tp_base*/             0,
    /*tp_dict*/             0,
...
static void QAudioInput_PythonToCpp_QAudioInput_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QAudioInput_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QAudioInput_PythonToCpp_QAudioInput_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QAudioInput_Type))
...
static PyObject* QAudioInput_PTR_CppToPython_QAudioInput(const void* cppIn) {
    return PySide::getWrapperForQObject((::QAudioInput*)cppIn, &Sbk_QAudioInput_Type);

}

void init_QAudioInput(PyObject* module)
{
    SbkPySide_QtMultimediaTypes[SBK_QAUDIOINPUT_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QAudioInput_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QAudioInput", "QAudioInput*",
        &Sbk_QAudioInput_Type, &Shiboken::callCppDestructor< ::QAudioInput >, (SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QOBJECT_IDX])) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QAudioInput_Type,
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(&Sbk_QAudioInput_Type, &Sbk_QAudioInput_typeDiscovery);

    PySide::Signal::registerSignals(&Sbk_QAudioInput_Type, &::QAudioInput::staticMetaObject);

    Shiboken::ObjectType::setSubTypeInitHook(&Sbk_QAudioInput_Type, &PySide::initQObjectSubType);
    PySide::initDynamicMetaObject(&Sbk_QAudioInput_Type, &::QAudioInput::staticMetaObject, sizeof(::QAudioInput));
}
