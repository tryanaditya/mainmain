...
// Converter indices
#define SBK_QTNETWORK_QLIST_QNETWORKPROXY_IDX                        0 // QList<QNetworkProxy >
#define SBK_QTNETWORK_QLIST_QHOSTADDRESS_IDX                         1 // QList<QHostAddress >
#define SBK_QTNETWORK_QHASH_QSTRING_QVARIANT_IDX                     2 // QHash<QString, QVariant >
#define SBK_QTNETWORK_QLIST_QSSLCERTIFICATE_IDX                      3 // QList<QSslCertificate >
#define SBK_QTNETWORK_QLIST_QSSLCIPHER_IDX                           4 // QList<QSslCipher >
#define SBK_QTNETWORK_QPAIR_QSTRING_QSTRING_IDX                      5 // QPair<QString, QString >
#define SBK_QTNETWORK_QLIST_QPAIR_QSTRING_QSTRING_IDX                6 // const QList<QPair<QString, QString > > &
#define SBK_QTNETWORK_QHASH_QNETWORKREQUEST_ATTRIBUTE_QVARIANT_IDX   7 // QHash<QNetworkRequest::Attribute, QVariant >
#define SBK_QTNETWORK_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX                8 // QPair<QByteArray, QByteArray >
#define SBK_QTNETWORK_QLIST_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX          9 // QList<QPair<QByteArray, QByteArray > >
#define SBK_QTNETWORK_QLIST_QNETWORKADDRESSENTRY_IDX                 10 // QList<QNetworkAddressEntry >
#define SBK_QTNETWORK_QLIST_QNETWORKINTERFACE_IDX                    11 // QList<QNetworkInterface >
#define SBK_QTNETWORK_QPAIR_QHOSTADDRESS_INT_IDX                     12 // const QPair<QHostAddress, int > &
#define SBK_QTNETWORK_QLIST_QNETWORKCONFIGURATION_IDX                13 // QList<QNetworkConfiguration >
...
#define SBK_QTNETWORK_QLIST_QBYTEARRAY_IDX                           16 // QList<QByteArray >
