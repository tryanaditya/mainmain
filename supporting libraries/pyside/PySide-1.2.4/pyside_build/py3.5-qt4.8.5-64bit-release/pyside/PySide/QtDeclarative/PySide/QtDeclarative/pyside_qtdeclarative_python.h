...
#define SBK_QTDECLARATIVE_QLIST_QDECLARATIVEERROR_IDX                2 // const QList<QDeclarativeError > &
#define SBK_QTDECLARATIVE_QLIST_QGRAPHICSITEMPTR_IDX                 3 // QList<QGraphicsItem * >
#define SBK_QTDECLARATIVE_QLIST_QGRAPHICSTRANSFORMPTR_IDX            4 // const QList<QGraphicsTransform * > &
