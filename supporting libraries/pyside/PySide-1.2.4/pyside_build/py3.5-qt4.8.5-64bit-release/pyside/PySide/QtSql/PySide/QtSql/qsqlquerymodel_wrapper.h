...
#ifndef SBK_QSQLQUERYMODELWRAPPER_H
#define SBK_QSQLQUERYMODELWRAPPER_H
...
class QSqlQueryModelWrapper : public QSqlQueryModel
{
public:
    QSqlQueryModelWrapper(QObject * parent = 0);
...
#endif // SBK_QSQLQUERYMODELWRAPPER_H
