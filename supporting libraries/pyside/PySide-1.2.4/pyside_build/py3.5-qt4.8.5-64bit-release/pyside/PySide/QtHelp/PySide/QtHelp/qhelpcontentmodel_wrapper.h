...
#ifndef SBK_QHELPCONTENTMODELWRAPPER_H
#define SBK_QHELPCONTENTMODELWRAPPER_H
...
class QHelpContentModelWrapper : public QHelpContentModel
{
public:
    ...
    virtual ~QHelpContentModelWrapper();
public:
...
#endif // SBK_QHELPCONTENTMODELWRAPPER_H
