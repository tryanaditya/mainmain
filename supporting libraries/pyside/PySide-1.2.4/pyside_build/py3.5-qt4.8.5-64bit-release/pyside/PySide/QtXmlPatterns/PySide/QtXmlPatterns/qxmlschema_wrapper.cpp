...
{
    ::QXmlSchema* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QXmlSchema*)Shiboken::Conversions::cppPointer(SbkPySide_QtXmlPatternsTypes[SBK_QXMLSCHEMA_IDX], (SbkObject*)self));
    PyObject* pyResult = 0;
...
static PyObject* Sbk_QXmlSchemaFunc_load(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (numArgs + numNamedArgs > 2) {
        PyErr_SetString(PyExc_TypeError, "PySide.QtXmlPatterns.QXmlSchema.load(): too many arguments");
        return 0;
    } else if (numArgs < 1) {
        PyErr_SetString(PyExc_TypeError, "PySide.QtXmlPatterns.QXmlSchema.load(): not enough arguments");
        return 0;
    }
    ...
    // Overloaded function decisor
    // 0: load(QIODevice*,QUrl)
    // 1: load(QByteArray,QUrl)
    // 2: load(QUrl)
    if (numArgs == 1
    ...
    switch (overloadId) {
        case 0: // load(QIODevice * source, const QUrl & documentUri)
        {
            if (kwds) {
                ...
                if (value && pyArgs[1]) {
                    PyErr_SetString(PyExc_TypeError, "PySide.QtXmlPatterns.QXmlSchema.load(): got multiple values for keyword argument 'documentUri'.");
                    return 0;
                } else if (value) {
                    pyArgs[1] = value;
...
static PyObject* Sbk_QXmlSchemaFunc_setMessageHandler(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QXmlSchemaFunc_setMessageHandler_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtXmlPatterns.QXmlSchema.setMessageHandler", overloads);
        return 0;
}
...
static PyObject* Sbk_QXmlSchemaFunc_setUriResolver(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QXmlSchemaFunc_setUriResolver_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "PySide.QtXmlPatterns.QXmlSchema.setUriResolver", overloads);
        return 0;
}
...
static PyMethodDef Sbk_QXmlSchema_methods[] = {
    {"documentUri", (PyCFunction)Sbk_QXmlSchemaFunc_documentUri, METH_NOARGS},
    {"isValid", (PyCFunction)Sbk_QXmlSchemaFunc_isValid, METH_NOARGS},
    {"load", (PyCFunction)Sbk_QXmlSchemaFunc_load, METH_VARARGS|METH_KEYWORDS},
    {"messageHandler", (PyCFunction)Sbk_QXmlSchemaFunc_messageHandler, METH_NOARGS},
    {"namePool", (PyCFunction)Sbk_QXmlSchemaFunc_namePool, METH_NOARGS},
    {"setMessageHandler", (PyCFunction)Sbk_QXmlSchemaFunc_setMessageHandler, METH_O},
    {"setUriResolver", (PyCFunction)Sbk_QXmlSchemaFunc_setUriResolver, METH_O},
    {"uriResolver", (PyCFunction)Sbk_QXmlSchemaFunc_uriResolver, METH_NOARGS},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QXmlSchema_Type = { { {
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QXmlSchema_traverse,
    /*tp_clear*/            Sbk_QXmlSchema_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QXmlSchema_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
...
static void QXmlSchema_PythonToCpp_QXmlSchema_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QXmlSchema_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QXmlSchema_PythonToCpp_QXmlSchema_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QXmlSchema_Type))
...
static PyObject* QXmlSchema_PTR_CppToPython_QXmlSchema(const void* cppIn) {
    ...
    const char* typeName = typeid(*((::QXmlSchema*)cppIn)).name();
    return Shiboken::Object::newObject(&Sbk_QXmlSchema_Type, const_cast<void*>(cppIn), false, false, typeName);
}

void init_QXmlSchema(PyObject* module)
{
    SbkPySide_QtXmlPatternsTypes[SBK_QXMLSCHEMA_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QXmlSchema_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QXmlSchema", "QXmlSchema*",
        &Sbk_QXmlSchema_Type, &Shiboken::callCppDestructor< ::QXmlSchema >)) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QXmlSchema_Type,
