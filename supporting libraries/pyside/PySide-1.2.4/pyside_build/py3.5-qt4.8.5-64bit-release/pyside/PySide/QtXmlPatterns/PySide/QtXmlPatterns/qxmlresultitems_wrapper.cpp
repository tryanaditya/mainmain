...
{
    ::QXmlResultItems* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::QXmlResultItems*)Shiboken::Conversions::cppPointer(SbkPySide_QtXmlPatternsTypes[SBK_QXMLRESULTITEMS_IDX], (SbkObject*)self));
    PyObject* pyResult = 0;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::copyToPython((SbkObjectType*)SbkPySide_QtXmlPatternsTypes[SBK_QXMLITEM_IDX], &cppResult);
        }
    }
...
static PyMethodDef Sbk_QXmlResultItems_methods[] = {
    {"current", (PyCFunction)Sbk_QXmlResultItemsFunc_current, METH_NOARGS},
    {"hasError", (PyCFunction)Sbk_QXmlResultItemsFunc_hasError, METH_NOARGS},
    {"next", (PyCFunction)Sbk_QXmlResultItemsFunc_next, METH_NOARGS},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_QXmlResultItems_Type = { { {
    PyVarObject_HEAD_INIT(&SbkObjectType_Type, 0)
    /*tp_name*/             "PySide.QtXmlPatterns.QXmlResultItems",
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_QXmlResultItems_traverse,
    /*tp_clear*/            Sbk_QXmlResultItems_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_QXmlResultItems_methods,
    /*tp_members*/          0,
    /*tp_getset*/           0,
    ...
    /*tp_descr_set*/        0,
    /*tp_dictoffset*/       0,
    /*tp_init*/             Sbk_QXmlResultItems_Init,
    /*tp_alloc*/            0,
...
static void QXmlResultItems_PythonToCpp_QXmlResultItems_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_QXmlResultItems_Type, pyIn, cppOut);
}
static PythonToCppFunc is_QXmlResultItems_PythonToCpp_QXmlResultItems_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_QXmlResultItems_Type))
...
static PyObject* QXmlResultItems_PTR_CppToPython_QXmlResultItems(const void* cppIn) {
    ...
    const char* typeName = typeid(*((::QXmlResultItems*)cppIn)).name();
    return Shiboken::Object::newObject(&Sbk_QXmlResultItems_Type, const_cast<void*>(cppIn), false, false, typeName);
}

void init_QXmlResultItems(PyObject* module)
{
    SbkPySide_QtXmlPatternsTypes[SBK_QXMLRESULTITEMS_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_QXmlResultItems_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "QXmlResultItems", "QXmlResultItems*",
        &Sbk_QXmlResultItems_Type, &Shiboken::callCppDestructor< ::QXmlResultItems >)) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_QXmlResultItems_Type,
