...
#ifndef SBK_QTABLEVIEWWRAPPER_H
#define SBK_QTABLEVIEWWRAPPER_H
...
{
public:
    QTableViewWrapper(QWidget * parent = 0);
    ...
    virtual ~QTableViewWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline void edit(const QModelIndex & index) { QTableView::edit(index); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QTABLEVIEWWRAPPER_H
