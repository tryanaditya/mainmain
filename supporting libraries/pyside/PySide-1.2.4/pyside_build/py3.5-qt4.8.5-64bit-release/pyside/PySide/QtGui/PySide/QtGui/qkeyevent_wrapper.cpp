...
Sbk_QKeyEvent_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    Sbk_QKeyEvent_Init_TypeError:
        const char* overloads[] = {"PySide.QtCore.QEvent.Type, int, PySide.QtCore.Qt.KeyboardModifiers, unicode = QString(), bool = false, unsigned short int = 1", 0};
...
static PyObject* Sbk_QKeyEventFunc_createExtendedKeyEvent(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    Sbk_QKeyEventFunc_createExtendedKeyEvent_TypeError:
        const char* overloads[] = {"PySide.QtCore.QEvent.Type, int, PySide.QtCore.Qt.KeyboardModifiers, unsigned int, unsigned int, unsigned int, unicode = QString(), bool = false, unsigned short int = 1", 0};
