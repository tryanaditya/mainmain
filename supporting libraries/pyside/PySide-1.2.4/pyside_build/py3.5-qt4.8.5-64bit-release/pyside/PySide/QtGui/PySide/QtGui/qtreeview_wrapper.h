...
#ifndef SBK_QTREEVIEWWRAPPER_H
#define SBK_QTREEVIEWWRAPPER_H
...
class QTreeViewWrapper : public QTreeView
{
public:
    QTreeViewWrapper(QWidget * parent = 0);
