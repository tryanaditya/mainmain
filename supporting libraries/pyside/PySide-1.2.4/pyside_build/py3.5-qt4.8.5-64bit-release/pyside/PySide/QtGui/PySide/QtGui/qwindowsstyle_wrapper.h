...
#ifndef SBK_QWINDOWSSTYLEWRAPPER_H
#define SBK_QWINDOWSSTYLEWRAPPER_H
...
class QWindowsStyleWrapper : public QWindowsStyle
{
public:
    QWindowsStyleWrapper();
    ...
    virtual ~QWindowsStyleWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline QPixmap standardPixmap(int standardPixmap, const QStyleOption * opt, const QWidget * widget = 0) const { return QWindowsStyle::standardPixmap(QStyle::StandardPixmap(standardPixmap), opt, widget); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QWINDOWSSTYLEWRAPPER_H
