...
#ifndef SBK_QLISTVIEWWRAPPER_H
#define SBK_QLISTVIEWWRAPPER_H
...
class QListViewWrapper : public QListView
{
public:
    ...
    virtual ~QListViewWrapper();
public:
    virtual int qt_metacall(QMetaObject::Call call, int id, void** args);
    virtual void* qt_metacast(const char* _clname);
    // Inherited overloads, because the using keyword sux
    inline void edit(const QModelIndex & index) { QListView::edit(index); }
    static void pysideInitQtMetaTypes();
};

#endif // SBK_QLISTVIEWWRAPPER_H
