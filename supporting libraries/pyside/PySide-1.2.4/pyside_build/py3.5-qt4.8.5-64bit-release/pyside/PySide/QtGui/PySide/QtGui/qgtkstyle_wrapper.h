...
#ifndef SBK_QGTKSTYLEWRAPPER_H
#define SBK_QGTKSTYLEWRAPPER_H
...
class QGtkStyleWrapper : public QGtkStyle
{
public:
    QGtkStyleWrapper();
    ...
    virtual void drawControl(QStyle::ControlElement control, const QStyleOption * option, QPainter * painter, const QWidget * widget) const;
    ...
    virtual QPixmap standardPixmap(QStyle::StandardPixmap sp, const QStyleOption * option, const QWidget * widget) const;
    ...
    virtual QRect subElementRect(QStyle::SubElement sr, const QStyleOption * opt, const QWidget * w) const;
    virtual void timerEvent(QTimerEvent * event);
    virtual void unpolish(QApplication * app);
    virtual void unpolish(QWidget * widget);
    virtual ~QGtkStyleWrapper();
public:
