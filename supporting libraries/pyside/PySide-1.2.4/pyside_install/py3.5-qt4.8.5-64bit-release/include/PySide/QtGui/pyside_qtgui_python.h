...
// Converter indices
#define SBK_QTGUI_QLIST_INT_IDX                                      0 // QList<int >
#define SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX              1 // QList<QFontDatabase::WritingSystem >
...
#define SBK_QTGUI_QLIST_QTREEWIDGETITEMPTR_IDX                       4 // const QList<QTreeWidgetItem * > &
#define SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                         5 // const QList<QStandardItem * > &
#define SBK_QTGUI_QLIST_QITEMSELECTIONRANGE_IDX                      6 // const QList<QItemSelectionRange > &
#define SBK_QTGUI_QSET_QITEMSELECTIONRANGE_IDX                       7 // const QSet<QItemSelectionRange > &
#define SBK_QTGUI_QVECTOR_QITEMSELECTIONRANGE_IDX                    8 // const QVector<QItemSelectionRange > &
...
#define SBK_QTGUI_QLIST_QBYTEARRAY_IDX                               14 // QList<QByteArray >
#define SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                             15 // QList<QKeySequence >
...
#define SBK_QTGUI_QVECTOR_QTEXTLAYOUT_FORMATRANGE_IDX                24 // const QVector<QTextLayout::FormatRange > &
#define SBK_QTGUI_QVECTOR_UNSIGNEDINT_IDX                            25 // QVector<unsigned int >
#define SBK_QTGUI_QLIST_QGRAPHICSITEMPTR_IDX                         26 // QList<QGraphicsItem * >
#define SBK_QTGUI_QLIST_QGRAPHICSTRANSFORMPTR_IDX                    27 // const QList<QGraphicsTransform * > &
#define SBK_QTGUI_QLIST_QSIZE_IDX                                    28 // QList<QSize >
#define SBK_QTGUI_QVECTOR_QLINE_IDX                                  29 // const QVector<QLine > &
#define SBK_QTGUI_QVECTOR_QLINEF_IDX                                 30 // const QVector<QLineF > &
#define SBK_QTGUI_QVECTOR_QRECT_IDX                                  31 // const QVector<QRect > &
#define SBK_QTGUI_QVECTOR_QRECTF_IDX                                 32 // const QVector<QRectF > &
#define SBK_QTGUI_QLIST_QGESTUREPTR_IDX                              33 // const QList<QGesture * > &
#define SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX              34 // const QList<QInputMethodEvent::Attribute > &
#define SBK_QTGUI_QLIST_QTOUCHEVENT_TOUCHPOINT_IDX                   35 // const QList<QTouchEvent::TouchPoint > &
#define SBK_QTGUI_QLIST_QOBJECTPTR_IDX                               36 // const QList<QObject * > &
#define SBK_QTGUI_QLIST_QRECTF_IDX                                   37 // const QList<QRectF > &
#define SBK_QTGUI_QLIST_QGRAPHICSVIEWPTR_IDX                         38 // QList<QGraphicsView * >
#define SBK_QTGUI_QPAIR_QREAL_QPOINTF_IDX                            39 // QPair<qreal, QPointF >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QPOINTF_IDX                      40 // QList<QPair<qreal, QPointF > >
#define SBK_QTGUI_QPAIR_QREAL_QREAL_IDX                              41 // QPair<qreal, qreal >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QREAL_IDX                        42 // QList<QPair<qreal, qreal > >
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           43 // const QHash<int, QByteArray > &
#define SBK_QTGUI_QLIST_QABSTRACTBUTTONPTR_IDX                       44 // QList<QAbstractButton * >
#define SBK_QTGUI_QLIST_QACTIONPTR_IDX                               45 // QList<QAction * >
#define SBK_QTGUI_QLIST_QGRAPHICSWIDGETPTR_IDX                       46 // QList<QGraphicsWidget * >
#define SBK_QTGUI_QLIST_QWIDGETPTR_IDX                               47 // QList<QWidget * >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            48 // QList<QTextFrame * >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               49 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                            50 // QList<QUndoStack * >
#define SBK_QTGUI_QMAP_QDATE_QTEXTCHARFORMAT_IDX                     51 // QMap<QDate, QTextCharFormat >
#define SBK_QTGUI_QLIST_QTABLEWIDGETITEMPTR_IDX                      52 // QList<QTableWidgetItem * >
#define SBK_QTGUI_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX               53 // QList<QTableWidgetSelectionRange >
#define SBK_QTGUI_QLIST_QLISTWIDGETITEMPTR_IDX                       54 // QList<QListWidgetItem * >
#define SBK_QTGUI_QLIST_QURL_IDX                                     55 // const QList<QUrl > &
#define SBK_QTGUI_QLIST_QWIZARD_WIZARDBUTTON_IDX                     56 // const QList<QWizard::WizardButton > &
#define SBK_QTGUI_QLIST_QTEXTEDIT_EXTRASELECTION_IDX                 57 // QList<QTextEdit::ExtraSelection >
#define SBK_QTGUI_QLIST_QMDISUBWINDOWPTR_IDX                         58 // QList<QMdiSubWindow * >
#define SBK_QTGUI_QLIST_QDOCKWIDGETPTR_IDX                           59 // QList<QDockWidget * >
#define SBK_QTGUI_QLIST_QABSTRACTANIMATIONPTR_IDX                    60 // QList<QAbstractAnimation * >
#define SBK_QTGUI_QLIST_QABSTRACTSTATEPTR_IDX                        61 // const QList<QAbstractState * > &
