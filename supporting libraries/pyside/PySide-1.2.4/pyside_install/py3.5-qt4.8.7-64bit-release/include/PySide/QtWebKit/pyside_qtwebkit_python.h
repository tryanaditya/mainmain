...
// Converter indices
#define SBK_QTWEBKIT_QLIST_QWEBSECURITYORIGIN_IDX                    0 // QList<QWebSecurityOrigin >
#define SBK_QTWEBKIT_QLIST_QWEBDATABASE_IDX                          1 // QList<QWebDatabase >
#define SBK_QTWEBKIT_QLIST_QWEBHISTORYITEM_IDX                       2 // QList<QWebHistoryItem >
