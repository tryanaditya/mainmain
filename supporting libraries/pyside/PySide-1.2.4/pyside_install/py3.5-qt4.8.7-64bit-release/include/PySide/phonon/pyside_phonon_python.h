...
#define SBK_PHONON_OBJECTDESCRIPTIONTYPE_IDX                         41
#define SBK_PHONON_DISCTYPE_IDX                                      23
#define SBK_PHONON_METADATA_IDX                                      40
#define SBK_PHONON_STATE_IDX                                         45
#define SBK_PHONON_CATEGORY_IDX                                      22
#define SBK_PHONON_CAPTURECATEGORY_IDX                               21
#define SBK_PHONON_ERRORTYPE_IDX                                     31
#define SBK_PHONON_BACKENDCAPABILITIES_IDX                           17
#define SBK_PHONON_VOLUMEFADERINTERFACE_IDX                          56
#define SBK_PHONON_VIDEOWIDGETINTERFACE_IDX                          53
#define SBK_PHONON_STREAMINTERFACE_IDX                               46
#define SBK_PHONON_PLATFORMPLUGIN_IDX                                43
#define SBK_PHONON_MEDIAOBJECTINTERFACE_IDX                          37
#define SBK_PHONON_MEDIASOURCE_IDX                                   38
#define SBK_PHONON_MEDIASOURCE_TYPE_IDX                              39
#define SBK_PHONON_EFFECTPARAMETER_IDX                               28
#define SBK_PHONON_EFFECTPARAMETER_HINT_IDX                          29
#define SBK_QFLAGS_PHONON_EFFECTPARAMETER_HINT__IDX                  58
#define SBK_PHONON_EFFECTINTERFACE_IDX                               27
...
#define SBK_PHONON_MEDIANODE_IDX                                     35
#define SBK_PHONON_ABSTRACTVIDEOOUTPUT_IDX                           3
#define SBK_PHONON_PATH_IDX                                          42
...
#define SBK_PHONON_SUBTITLEDESCRIPTION_IDX                           47
#define SBK_PHONON_OBJECTDESCRIPTION_PHONON_SUBTITLETYPE_IDX         47
#define SBK_PHONON_VIDEOCAPTUREDEVICE_IDX                            48
#define SBK_PHONON_OBJECTDESCRIPTION_PHONON_VIDEOCAPTUREDEVICETYPE_IDX 48
#define SBK_PHONON_EFFECTDESCRIPTION_IDX                             25
#define SBK_PHONON_OBJECTDESCRIPTION_PHONON_EFFECTTYPE_IDX           25
#define SBK_PHONON_EFFECTDESCRIPTIONMODEL_IDX                        26
#define SBK_PHONON_OBJECTDESCRIPTIONMODEL_PHONON_EFFECTTYPE_IDX      26
...
#define SBK_PHONON_MEDIAOBJECT_IDX                                   36
#define SBK_PHONON_MEDIACONTROLLER_IDX                               32
#define SBK_PHONON_MEDIACONTROLLER_FEATURE_IDX                       33
#define SBK_QFLAGS_PHONON_MEDIACONTROLLER_FEATURE__IDX               59
#define SBK_PHONON_MEDIACONTROLLER_NAVIGATIONMENU_IDX                34
#define SBK_PHONON_VOLUMESLIDER_IDX                                  57
#define SBK_PHONON_VIDEOWIDGET_IDX                                   50
#define SBK_PHONON_VIDEOWIDGET_ASPECTRATIO_IDX                       51
#define SBK_PHONON_VIDEOWIDGET_SCALEMODE_IDX                         52
#define SBK_PHONON_VIDEOPLAYER_IDX                                   49
#define SBK_PHONON_SEEKSLIDER_IDX                                    44
#define SBK_PHONON_EFFECTWIDGET_IDX                                  30
#define SBK_PHONON_EFFECT_IDX                                        24
#define SBK_PHONON_VOLUMEFADEREFFECT_IDX                             54
#define SBK_PHONON_VOLUMEFADEREFFECT_FADECURVE_IDX                   55
...
#define SBK_phonon_IDX_COUNT                                         60
...
// Converter indices
#define SBK_PHONON_QLIST_PHONON_VIDEOCAPTUREDEVICE_IDX               0 // QList<Phonon::VideoCaptureDevice >
#define SBK_PHONON_QLIST_PHONON_AUDIOCAPTUREDEVICE_IDX               1 // QList<Phonon::AudioCaptureDevice >
#define SBK_PHONON_QLIST_PHONON_EFFECTDESCRIPTION_IDX                2 // QList<Phonon::EffectDescription >
#define SBK_PHONON_QLIST_PHONON_AUDIOOUTPUTDEVICE_IDX                3 // QList<Phonon::AudioOutputDevice >
#define SBK_PHONON_QLIST_QOBJECTPTR_IDX                              4 // const QList<QObject * > &
#define SBK_PHONON_QLIST_QBYTEARRAY_IDX                              5 // QList<QByteArray >
#define SBK_PHONON_QLIST_QACTIONPTR_IDX                              6 // QList<QAction * >
#define SBK_PHONON_QPAIR_QBYTEARRAY_QSTRING_IDX                      7 // QPair<QByteArray, QString >
#define SBK_PHONON_QLIST_QPAIR_QBYTEARRAY_QSTRING_IDX                8 // QList<QPair<QByteArray, QString > >
#define SBK_PHONON_QLIST_INT_IDX                                     9 // QList<int >
#define SBK_PHONON_QHASH_QBYTEARRAY_QVARIANT_IDX                     10 // QHash<QByteArray, QVariant >
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_EFFECTTYPE__IDX 11 // const QList<Phonon::ObjectDescription<Phonon::EffectType > > &
#define SBK_PHONON_QMAP_INT_QVARIANT_IDX                             12 // QMap<int, QVariant >
#define SBK_PHONON_QHASH_INT_QBYTEARRAY_IDX                          13 // const QHash<int, QByteArray > &
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_AUDIOOUTPUTDEVICETYPE__IDX 14 // const QList<Phonon::ObjectDescription<Phonon::AudioOutputDeviceType > > &
#define SBK_PHONON_QLIST_PHONON_AUDIOCHANNELDESCRIPTION_IDX          15 // QList<Phonon::AudioChannelDescription >
#define SBK_PHONON_QLIST_PHONON_MEDIACONTROLLER_NAVIGATIONMENU_IDX   16 // QList<Phonon::MediaController::NavigationMenu >
#define SBK_PHONON_QLIST_PHONON_SUBTITLEDESCRIPTION_IDX              17 // QList<Phonon::SubtitleDescription >
#define SBK_PHONON_QLIST_QVARIANT_IDX                                18 // const QList<QVariant > &
#define SBK_PHONON_QLIST_PHONON_EFFECTPARAMETER_IDX                  19 // QList<Phonon::EffectParameter >
#define SBK_PHONON_QSET_QOBJECTPTR_IDX                               20 // QSet<QObject * >
#define SBK_PHONON_QLIST_PHONON_PATH_IDX                             21 // QList<Phonon::Path >
#define SBK_PHONON_QLIST_PHONON_MEDIASOURCE_IDX                      22 // const QList<Phonon::MediaSource > &
#define SBK_PHONON_QLIST_QURL_IDX                                    23 // const QList<QUrl > &
#define SBK_PHONON_QMULTIMAP_QSTRING_QSTRING_IDX                     24 // QMultiMap<QString, QString >
#define SBK_PHONON_QLIST_PHONON_EFFECTPTR_IDX                        25 // QList<Phonon::Effect * >
#define SBK_PHONON_QLIST_QSTRING_IDX                                 26 // QList<QString >
#define SBK_PHONON_QMAP_QSTRING_QVARIANT_IDX                         27 // QMap<QString, QVariant >
#define SBK_phonon_CONVERTERS_IDX_COUNT                              28
...
template<> inline PyTypeObject* SbkType< ::Phonon::CaptureCategory >() { return SbkPySide_phononTypes[SBK_PHONON_CAPTURECATEGORY_IDX]; }
...
template<> inline PyTypeObject* SbkType< ::Phonon::VideoCaptureDevice >() { return reinterpret_cast<PyTypeObject*>(SbkPySide_phononTypes[SBK_PHONON_VIDEOCAPTUREDEVICE_IDX]); }
...
template<> inline PyTypeObject* SbkType< ::Phonon::MediaController::NavigationMenu >() { return SbkPySide_phononTypes[SBK_PHONON_MEDIACONTROLLER_NAVIGATIONMENU_IDX]; }
